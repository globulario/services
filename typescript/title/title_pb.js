...
goog.exportSymbol('proto.title.GetSeriesEpisodesRequest', null, global);
goog.exportSymbol('proto.title.GetSeriesEpisodesResponse', null, global);
...
goog.exportSymbol('proto.title.GetWatchingRequest', null, global);
goog.exportSymbol('proto.title.ListWatchingRequest', null, global);
goog.exportSymbol('proto.title.ListWatchingResponse', null, global);
...
goog.exportSymbol('proto.title.RebuildIndexRequest', null, global);
goog.exportSymbol('proto.title.RemoveWatchingRequest', null, global);
goog.exportSymbol('proto.title.SaveWatchingRequest', null, global);
...
goog.exportSymbol('proto.title.WatchingEntry', null, global);
/**
 ...
 * @constructor
 */
proto.title.WatchingEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.WatchingEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.WatchingEntry.displayName = 'proto.title.WatchingEntry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.ListWatchingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.ListWatchingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.ListWatchingRequest.displayName = 'proto.title.ListWatchingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.ListWatchingResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.title.ListWatchingResponse.repeatedFields_, null);
};
goog.inherits(proto.title.ListWatchingResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.ListWatchingResponse.displayName = 'proto.title.ListWatchingResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.GetWatchingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.GetWatchingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.GetWatchingRequest.displayName = 'proto.title.GetWatchingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.SaveWatchingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.SaveWatchingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.SaveWatchingRequest.displayName = 'proto.title.SaveWatchingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.RemoveWatchingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.RemoveWatchingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.RemoveWatchingRequest.displayName = 'proto.title.RemoveWatchingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.RebuildIndexRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.title.RebuildIndexRequest.repeatedFields_, null);
};
goog.inherits(proto.title.RebuildIndexRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.RebuildIndexRequest.displayName = 'proto.title.RebuildIndexRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.GetSeriesEpisodesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.title.GetSeriesEpisodesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.GetSeriesEpisodesRequest.displayName = 'proto.title.GetSeriesEpisodesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.title.GetSeriesEpisodesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.title.GetSeriesEpisodesResponse.repeatedFields_, null);
};
goog.inherits(proto.title.GetSeriesEpisodesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.title.GetSeriesEpisodesResponse.displayName = 'proto.title.GetSeriesEpisodesResponse';
}
 ...
 * @return {!Object}
 */
proto.title.WatchingEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.title.WatchingEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.WatchingEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.WatchingEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
id: jspb.Message.getFieldWithDefault(msg, 1, ""),
titleId: jspb.Message.getFieldWithDefault(msg, 2, ""),
userId: jspb.Message.getFieldWithDefault(msg, 3, ""),
domain: jspb.Message.getFieldWithDefault(msg, 4, ""),
positionMs: jspb.Message.getFieldWithDefault(msg, 5, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.WatchingEntry}
 */
proto.title.WatchingEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.WatchingEntry;
  return proto.title.WatchingEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.WatchingEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.WatchingEntry}
 */
proto.title.WatchingEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.WatchingEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.WatchingEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.WatchingEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.WatchingEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string title_id = 2;
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getTitleId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setTitleId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getDomain = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setDomain = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional int64 position_ms = 5;
 * @return {number}
 */
proto.title.WatchingEntry.prototype.getPositionMs = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setPositionMs = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.title.WatchingEntry.prototype.getDurationMs = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setDurationMs = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getMediaType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setMediaType = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};
 ...
 * @return {string}
 */
proto.title.WatchingEntry.prototype.getUpdatedAt = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.title.WatchingEntry} returns this
 */
proto.title.WatchingEntry.prototype.setUpdatedAt = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};
 ...
 * @return {!Object}
 */
proto.title.ListWatchingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.ListWatchingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.ListWatchingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.ListWatchingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.ListWatchingRequest}
 */
proto.title.ListWatchingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.ListWatchingRequest;
  return proto.title.ListWatchingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.ListWatchingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.ListWatchingRequest}
 */
proto.title.ListWatchingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.ListWatchingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.ListWatchingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.ListWatchingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.ListWatchingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.title.ListWatchingResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.title.ListWatchingResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.title.ListWatchingResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.ListWatchingResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.ListWatchingResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    proto.title.WatchingEntry.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.ListWatchingResponse}
 */
proto.title.ListWatchingResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.ListWatchingResponse;
  return proto.title.ListWatchingResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.ListWatchingResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.ListWatchingResponse}
 */
proto.title.ListWatchingResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.title.WatchingEntry;
      reader.readMessage(value,proto.title.WatchingEntry.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.title.ListWatchingResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.ListWatchingResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.ListWatchingResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.ListWatchingResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.title.WatchingEntry.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated WatchingEntry items = 1;
 * @return {!Array<!proto.title.WatchingEntry>}
 */
proto.title.ListWatchingResponse.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.title.WatchingEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.title.WatchingEntry, 1));
};


/**
 * @param {!Array<!proto.title.WatchingEntry>} value
 * @return {!proto.title.ListWatchingResponse} returns this
*/
proto.title.ListWatchingResponse.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.title.WatchingEntry=} opt_value
 * @param {number=} opt_index
 * @return {!proto.title.WatchingEntry}
 */
proto.title.ListWatchingResponse.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.title.WatchingEntry, opt_index);
};
 ...
 * @return {!proto.title.ListWatchingResponse} returns this
 */
proto.title.ListWatchingResponse.prototype.clearItemsList = function() {
 ...
 * @return {!Object}
 */
proto.title.GetWatchingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.GetWatchingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.GetWatchingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetWatchingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
titleId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.GetWatchingRequest}
 */
proto.title.GetWatchingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.GetWatchingRequest;
  return proto.title.GetWatchingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.GetWatchingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.GetWatchingRequest}
 */
proto.title.GetWatchingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.GetWatchingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.GetWatchingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.GetWatchingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetWatchingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitleId();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * optional string title_id = 1;
 * @return {string}
 */
proto.title.GetWatchingRequest.prototype.getTitleId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.title.GetWatchingRequest} returns this
 */
proto.title.GetWatchingRequest.prototype.setTitleId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.title.SaveWatchingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.SaveWatchingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.SaveWatchingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.SaveWatchingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
entry: (f = msg.getEntry()) && proto.title.WatchingEntry.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.SaveWatchingRequest}
 */
proto.title.SaveWatchingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.SaveWatchingRequest;
  return proto.title.SaveWatchingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.SaveWatchingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.SaveWatchingRequest}
 */
proto.title.SaveWatchingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.SaveWatchingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.SaveWatchingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.SaveWatchingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.SaveWatchingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEntry();
  if (f != null) {
    writer.writeMessage(
...
/**
 * optional WatchingEntry entry = 1;
 * @return {?proto.title.WatchingEntry}
 */
proto.title.SaveWatchingRequest.prototype.getEntry = function() {
  return /** @type{?proto.title.WatchingEntry} */ (
    jspb.Message.getWrapperField(this, proto.title.WatchingEntry, 1));
};


/**
 * @param {?proto.title.WatchingEntry|undefined} value
 * @return {!proto.title.SaveWatchingRequest} returns this
*/
proto.title.SaveWatchingRequest.prototype.setEntry = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.title.SaveWatchingRequest} returns this
 */
proto.title.SaveWatchingRequest.prototype.clearEntry = function() {
 ...
 * @return {boolean}
 */
proto.title.SaveWatchingRequest.prototype.hasEntry = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.title.RemoveWatchingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.RemoveWatchingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.RemoveWatchingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.RemoveWatchingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
titleId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.RemoveWatchingRequest}
 */
proto.title.RemoveWatchingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.RemoveWatchingRequest;
  return proto.title.RemoveWatchingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.RemoveWatchingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.RemoveWatchingRequest}
 */
proto.title.RemoveWatchingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.RemoveWatchingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.RemoveWatchingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.RemoveWatchingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.RemoveWatchingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitleId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.title.RemoveWatchingRequest.prototype.getTitleId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.title.RemoveWatchingRequest} returns this
 */
proto.title.RemoveWatchingRequest.prototype.setTitleId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.title.RebuildIndexRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.title.RebuildIndexRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.RebuildIndexRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.RebuildIndexRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.RebuildIndexRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.RebuildIndexRequest}
 */
proto.title.RebuildIndexRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.RebuildIndexRequest;
  return proto.title.RebuildIndexRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.RebuildIndexRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.RebuildIndexRequest}
 */
proto.title.RebuildIndexRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.RebuildIndexRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.RebuildIndexRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.RebuildIndexRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.RebuildIndexRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.title.RebuildIndexRequest.prototype.getCollectionsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.title.RebuildIndexRequest} returns this
 */
proto.title.RebuildIndexRequest.prototype.setCollectionsList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.title.RebuildIndexRequest} returns this
 */
proto.title.RebuildIndexRequest.prototype.addCollections = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.title.RebuildIndexRequest} returns this
 */
proto.title.RebuildIndexRequest.prototype.clearCollectionsList = function() {
 ...
 * @return {boolean}
 */
proto.title.RebuildIndexRequest.prototype.getIncremental = function() {
 ...
 * @return {!proto.title.RebuildIndexRequest} returns this
 */
proto.title.RebuildIndexRequest.prototype.setIncremental = function(value) {
 ...
 * @return {!Object}
 */
proto.title.GetSeriesEpisodesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.title.GetSeriesEpisodesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.GetSeriesEpisodesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetSeriesEpisodesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.GetSeriesEpisodesRequest}
 */
proto.title.GetSeriesEpisodesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.GetSeriesEpisodesRequest;
  return proto.title.GetSeriesEpisodesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.GetSeriesEpisodesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.GetSeriesEpisodesRequest}
 */
proto.title.GetSeriesEpisodesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.GetSeriesEpisodesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.GetSeriesEpisodesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.GetSeriesEpisodesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetSeriesEpisodesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.title.GetSeriesEpisodesRequest.prototype.getSeriesid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.title.GetSeriesEpisodesRequest} returns this
 */
proto.title.GetSeriesEpisodesRequest.prototype.setSeriesid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.title.GetSeriesEpisodesRequest.prototype.getIndexpath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.title.GetSeriesEpisodesRequest} returns this
 */
proto.title.GetSeriesEpisodesRequest.prototype.setIndexpath = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.title.GetSeriesEpisodesRequest.prototype.getSeason = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.title.GetSeriesEpisodesRequest} returns this
 */
proto.title.GetSeriesEpisodesRequest.prototype.setSeason = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @const
 */
proto.title.GetSeriesEpisodesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.title.GetSeriesEpisodesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.title.GetSeriesEpisodesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.title.GetSeriesEpisodesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetSeriesEpisodesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.title.GetSeriesEpisodesResponse}
 */
proto.title.GetSeriesEpisodesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.title.GetSeriesEpisodesResponse;
  return proto.title.GetSeriesEpisodesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.title.GetSeriesEpisodesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.title.GetSeriesEpisodesResponse}
 */
proto.title.GetSeriesEpisodesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.title.GetSeriesEpisodesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.title.GetSeriesEpisodesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.title.GetSeriesEpisodesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.title.GetSeriesEpisodesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * repeated Title episodes = 1;
 * @return {!Array<!proto.title.Title>}
 */
proto.title.GetSeriesEpisodesResponse.prototype.getEpisodesList = function() {
  return /** @type{!Array<!proto.title.Title>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.title.Title, 1));
};
...
/**
 * @param {!Array<!proto.title.Title>} value
 * @return {!proto.title.GetSeriesEpisodesResponse} returns this
*/
proto.title.GetSeriesEpisodesResponse.prototype.setEpisodesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.title.Title}
 */
proto.title.GetSeriesEpisodesResponse.prototype.addEpisodes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.title.Title, opt_index);
};
 ...
 * @return {!proto.title.GetSeriesEpisodesResponse} returns this
 */
proto.title.GetSeriesEpisodesResponse.prototype.clearEpisodesList = function() {
