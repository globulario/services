 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.media.ListMediaFilesRequest,
 *   !proto.media.MediaFile>}
 */
const methodDescriptor_MediaService_ListMediaFiles = new grpc.web.MethodDescriptor(
  '/media.MediaService/ListMediaFiles',
  grpc.web.MethodType.SERVER_STREAMING,
  proto.media.ListMediaFilesRequest,
  proto.media.MediaFile,
  /**
   * @param {!proto.media.ListMediaFilesRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.media.MediaFile.deserializeBinary
);


/**
 * @param {!proto.media.ListMediaFilesRequest} request The request proto
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.media.MediaFile>}
 *     The XHR Node Readable Stream
 */
proto.media.MediaServiceClient.prototype.listMediaFiles =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/media.MediaService/ListMediaFiles',
      request,
      metadata || {},
      methodDescriptor_MediaService_ListMediaFiles);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.media.MediaServicePromiseClient.prototype.listMediaFiles =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/media.MediaService/ListMediaFiles',
      request,
