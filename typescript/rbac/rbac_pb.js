...
proto.rbac.Permission.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    applicationsList: jspb.Message.getRepeatedField(msg, 2),
...
proto.rbac.Share.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    applicationsList: jspb.Message.getRepeatedField(msg, 3),
    peersList: jspb.Message.getRepeatedField(msg, 4),
    accountsList: jspb.Message.getRepeatedField(msg, 5),
    groupsList: jspb.Message.getRepeatedField(msg, 6),
...
proto.rbac.ValidateSubjectSpaceRsp.toObject = function(includeInstance, msg) {
  var f, obj = {
    hasspace: jspb.Message.getFieldWithDefault(msg, 1, false)
  };
