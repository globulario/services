 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.storage.GetAllKeysRequest,
 *   !proto.storage.GetAllKeysResponse>}
 */
const methodDescriptor_StorageService_GetAllKeys = new grpc.web.MethodDescriptor(
  '/storage.StorageService/GetAllKeys',
  grpc.web.MethodType.SERVER_STREAMING,
  proto.storage.GetAllKeysRequest,
  proto.storage.GetAllKeysResponse,
  /**
   * @param {!proto.storage.GetAllKeysRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.storage.GetAllKeysResponse.deserializeBinary
);


/**
 * @param {!proto.storage.GetAllKeysRequest} request The request proto
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.storage.GetAllKeysResponse>}
 *     The XHR Node Readable Stream
 */
proto.storage.StorageServiceClient.prototype.getAllKeys =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/storage.StorageService/GetAllKeys',
      request,
      metadata || {},
      methodDescriptor_StorageService_GetAllKeys);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.storage.StorageServicePromiseClient.prototype.getAllKeys =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/storage.StorageService/GetAllKeys',
      request,
