...
template<> ::echo::StopRequest* Arena::CreateMaybeMessage<::echo::StopRequest>(Arena*);
template<> ::echo::StopResponse* Arena::CreateMaybeMessage<::echo::StopResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace echo {
...
class EchoResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 message_count() const;
  void set_message_count(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_message_count() const;
  void _internal_set_message_count(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr message_;
  ::PROTOBUF_NAMESPACE_ID::int32 message_count_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_echo_2eproto;
};
// -------------------------------------------------------------------
...
class StopRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:echo.StopRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:echo.StopRequest)
 private:
  class _Internal;
...
class StopResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:echo.StopResponse) */ {
 public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 EchoResponse::_internal_message_count() const {
  return message_count_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 EchoResponse::message_count() const {
  // @@protoc_insertion_point(field_get:echo.EchoResponse.message_count)
  return _internal_message_count();
}
inline void EchoResponse::_internal_set_message_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  message_count_ = value;
}
inline void EchoResponse::set_message_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_message_count(value);
  // @@protoc_insertion_point(field_set:echo.EchoResponse.message_count)
}
