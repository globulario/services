...
class CreateDirPermissionsRqst;
class CreateDirPermissionsRqstDefaultTypeInternal;
extern CreateDirPermissionsRqstDefaultTypeInternal _CreateDirPermissionsRqst_default_instance_;
class CreateDirPermissionsRsp;
class CreateDirPermissionsRspDefaultTypeInternal;
extern CreateDirPermissionsRspDefaultTypeInternal _CreateDirPermissionsRsp_default_instance_;
...
class DeleteDirPermissionsRqst;
class DeleteDirPermissionsRqstDefaultTypeInternal;
extern DeleteDirPermissionsRqstDefaultTypeInternal _DeleteDirPermissionsRqst_default_instance_;
class DeleteDirPermissionsRsp;
class DeleteDirPermissionsRspDefaultTypeInternal;
extern DeleteDirPermissionsRspDefaultTypeInternal _DeleteDirPermissionsRsp_default_instance_;
class DeleteFilePermissionsRqst;
class DeleteFilePermissionsRqstDefaultTypeInternal;
extern DeleteFilePermissionsRqstDefaultTypeInternal _DeleteFilePermissionsRqst_default_instance_;
class DeleteFilePermissionsRsp;
class DeleteFilePermissionsRspDefaultTypeInternal;
extern DeleteFilePermissionsRspDefaultTypeInternal _DeleteFilePermissionsRsp_default_instance_;
class DeleteLogRqst;
...
class RenameFilePermissionRqst;
class RenameFilePermissionRqstDefaultTypeInternal;
extern RenameFilePermissionRqstDefaultTypeInternal _RenameFilePermissionRqst_default_instance_;
class RenameFilePermissionRsp;
class RenameFilePermissionRspDefaultTypeInternal;
extern RenameFilePermissionRspDefaultTypeInternal _RenameFilePermissionRsp_default_instance_;
...
template<> ::ressource::CreateDirPermissionsRqst* Arena::CreateMaybeMessage<::ressource::CreateDirPermissionsRqst>(Arena*);
template<> ::ressource::CreateDirPermissionsRsp* Arena::CreateMaybeMessage<::ressource::CreateDirPermissionsRsp>(Arena*);
...
template<> ::ressource::DeleteDirPermissionsRqst* Arena::CreateMaybeMessage<::ressource::DeleteDirPermissionsRqst>(Arena*);
template<> ::ressource::DeleteDirPermissionsRsp* Arena::CreateMaybeMessage<::ressource::DeleteDirPermissionsRsp>(Arena*);
template<> ::ressource::DeleteFilePermissionsRqst* Arena::CreateMaybeMessage<::ressource::DeleteFilePermissionsRqst>(Arena*);
...
template<> ::ressource::RenameFilePermissionRqst* Arena::CreateMaybeMessage<::ressource::RenameFilePermissionRqst>(Arena*);
template<> ::ressource::RenameFilePermissionRsp* Arena::CreateMaybeMessage<::ressource::RenameFilePermissionRsp>(Arena*);
...
class CreateDirPermissionsRqst PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.CreateDirPermissionsRqst) */ {
 public:
  inline CreateDirPermissionsRqst() : CreateDirPermissionsRqst(nullptr) {}
  virtual ~CreateDirPermissionsRqst();

  CreateDirPermissionsRqst(const CreateDirPermissionsRqst& from);
  CreateDirPermissionsRqst(CreateDirPermissionsRqst&& from) noexcept
    : CreateDirPermissionsRqst() {
    *this = ::std::move(from);
  }

  inline CreateDirPermissionsRqst& operator=(const CreateDirPermissionsRqst& from) {
    CopyFrom(from);
    return *this;
  }
  inline CreateDirPermissionsRqst& operator=(CreateDirPermissionsRqst&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CreateDirPermissionsRqst& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CreateDirPermissionsRqst* internal_default_instance() {
    return reinterpret_cast<const CreateDirPermissionsRqst*>(
  ...
  inline void Swap(CreateDirPermissionsRqst* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(CreateDirPermissionsRqst* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline CreateDirPermissionsRqst* New() const final {
    return CreateMaybeMessage<CreateDirPermissionsRqst>(nullptr);
  }

  CreateDirPermissionsRqst* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CreateDirPermissionsRqst>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CreateDirPermissionsRqst& from);
  void MergeFrom(const CreateDirPermissionsRqst& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CreateDirPermissionsRqst* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.CreateDirPermissionsRqst";
  }
  protected:
  explicit CreateDirPermissionsRqst(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.CreateDirPermissionsRqst)
 private:
  class _Internal;
...
class CreateDirPermissionsRsp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.CreateDirPermissionsRsp) */ {
 public:
  inline CreateDirPermissionsRsp() : CreateDirPermissionsRsp(nullptr) {}
  virtual ~CreateDirPermissionsRsp();

  CreateDirPermissionsRsp(const CreateDirPermissionsRsp& from);
  CreateDirPermissionsRsp(CreateDirPermissionsRsp&& from) noexcept
    : CreateDirPermissionsRsp() {
    *this = ::std::move(from);
  }

  inline CreateDirPermissionsRsp& operator=(const CreateDirPermissionsRsp& from) {
    CopyFrom(from);
    return *this;
  }
  inline CreateDirPermissionsRsp& operator=(CreateDirPermissionsRsp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CreateDirPermissionsRsp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CreateDirPermissionsRsp* internal_default_instance() {
    return reinterpret_cast<const CreateDirPermissionsRsp*>(
  ...
  inline void Swap(CreateDirPermissionsRsp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(CreateDirPermissionsRsp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline CreateDirPermissionsRsp* New() const final {
    return CreateMaybeMessage<CreateDirPermissionsRsp>(nullptr);
  }

  CreateDirPermissionsRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CreateDirPermissionsRsp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CreateDirPermissionsRsp& from);
  void MergeFrom(const CreateDirPermissionsRsp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CreateDirPermissionsRsp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.CreateDirPermissionsRsp";
  }
  protected:
  explicit CreateDirPermissionsRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.CreateDirPermissionsRsp)
 private:
  class _Internal;
...
class RenameFilePermissionRqst PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.RenameFilePermissionRqst) */ {
 public:
  inline RenameFilePermissionRqst() : RenameFilePermissionRqst(nullptr) {}
  virtual ~RenameFilePermissionRqst();

  RenameFilePermissionRqst(const RenameFilePermissionRqst& from);
  RenameFilePermissionRqst(RenameFilePermissionRqst&& from) noexcept
    : RenameFilePermissionRqst() {
    *this = ::std::move(from);
  }

  inline RenameFilePermissionRqst& operator=(const RenameFilePermissionRqst& from) {
    CopyFrom(from);
    return *this;
  }
  inline RenameFilePermissionRqst& operator=(RenameFilePermissionRqst&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const RenameFilePermissionRqst& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RenameFilePermissionRqst* internal_default_instance() {
    return reinterpret_cast<const RenameFilePermissionRqst*>(
  ...
  inline void Swap(RenameFilePermissionRqst* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RenameFilePermissionRqst* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline RenameFilePermissionRqst* New() const final {
    return CreateMaybeMessage<RenameFilePermissionRqst>(nullptr);
  }

  RenameFilePermissionRqst* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RenameFilePermissionRqst>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RenameFilePermissionRqst& from);
  void MergeFrom(const RenameFilePermissionRqst& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RenameFilePermissionRqst* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.RenameFilePermissionRqst";
  }
  protected:
  explicit RenameFilePermissionRqst(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.RenameFilePermissionRqst)
 private:
  class _Internal;
...
class RenameFilePermissionRsp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.RenameFilePermissionRsp) */ {
 public:
  inline RenameFilePermissionRsp() : RenameFilePermissionRsp(nullptr) {}
  virtual ~RenameFilePermissionRsp();

  RenameFilePermissionRsp(const RenameFilePermissionRsp& from);
  RenameFilePermissionRsp(RenameFilePermissionRsp&& from) noexcept
    : RenameFilePermissionRsp() {
    *this = ::std::move(from);
  }

  inline RenameFilePermissionRsp& operator=(const RenameFilePermissionRsp& from) {
    CopyFrom(from);
    return *this;
  }
  inline RenameFilePermissionRsp& operator=(RenameFilePermissionRsp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const RenameFilePermissionRsp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RenameFilePermissionRsp* internal_default_instance() {
    return reinterpret_cast<const RenameFilePermissionRsp*>(
  ...
  inline void Swap(RenameFilePermissionRsp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RenameFilePermissionRsp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline RenameFilePermissionRsp* New() const final {
    return CreateMaybeMessage<RenameFilePermissionRsp>(nullptr);
  }

  RenameFilePermissionRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RenameFilePermissionRsp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RenameFilePermissionRsp& from);
  void MergeFrom(const RenameFilePermissionRsp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RenameFilePermissionRsp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.RenameFilePermissionRsp";
  }
  protected:
  explicit RenameFilePermissionRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.RenameFilePermissionRsp)
 private:
  class _Internal;
...
class DeleteDirPermissionsRqst PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.DeleteDirPermissionsRqst) */ {
 public:
  inline DeleteDirPermissionsRqst() : DeleteDirPermissionsRqst(nullptr) {}
  virtual ~DeleteDirPermissionsRqst();

  DeleteDirPermissionsRqst(const DeleteDirPermissionsRqst& from);
  DeleteDirPermissionsRqst(DeleteDirPermissionsRqst&& from) noexcept
    : DeleteDirPermissionsRqst() {
    *this = ::std::move(from);
  }

  inline DeleteDirPermissionsRqst& operator=(const DeleteDirPermissionsRqst& from) {
    CopyFrom(from);
    return *this;
  }
  inline DeleteDirPermissionsRqst& operator=(DeleteDirPermissionsRqst&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DeleteDirPermissionsRqst& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DeleteDirPermissionsRqst* internal_default_instance() {
    return reinterpret_cast<const DeleteDirPermissionsRqst*>(
  ...
  inline void Swap(DeleteDirPermissionsRqst* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(DeleteDirPermissionsRqst* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline DeleteDirPermissionsRqst* New() const final {
    return CreateMaybeMessage<DeleteDirPermissionsRqst>(nullptr);
  }

  DeleteDirPermissionsRqst* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DeleteDirPermissionsRqst>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DeleteDirPermissionsRqst& from);
  void MergeFrom(const DeleteDirPermissionsRqst& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DeleteDirPermissionsRqst* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.DeleteDirPermissionsRqst";
  }
  protected:
  explicit DeleteDirPermissionsRqst(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.DeleteDirPermissionsRqst)
 private:
  class _Internal;
...
class DeleteDirPermissionsRsp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.DeleteDirPermissionsRsp) */ {
 public:
  inline DeleteDirPermissionsRsp() : DeleteDirPermissionsRsp(nullptr) {}
  virtual ~DeleteDirPermissionsRsp();

  DeleteDirPermissionsRsp(const DeleteDirPermissionsRsp& from);
  DeleteDirPermissionsRsp(DeleteDirPermissionsRsp&& from) noexcept
    : DeleteDirPermissionsRsp() {
    *this = ::std::move(from);
  }

  inline DeleteDirPermissionsRsp& operator=(const DeleteDirPermissionsRsp& from) {
    CopyFrom(from);
    return *this;
  }
  inline DeleteDirPermissionsRsp& operator=(DeleteDirPermissionsRsp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DeleteDirPermissionsRsp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DeleteDirPermissionsRsp* internal_default_instance() {
    return reinterpret_cast<const DeleteDirPermissionsRsp*>(
  ...
  inline void Swap(DeleteDirPermissionsRsp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(DeleteDirPermissionsRsp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline DeleteDirPermissionsRsp* New() const final {
    return CreateMaybeMessage<DeleteDirPermissionsRsp>(nullptr);
  }

  DeleteDirPermissionsRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DeleteDirPermissionsRsp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DeleteDirPermissionsRsp& from);
  void MergeFrom(const DeleteDirPermissionsRsp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DeleteDirPermissionsRsp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.DeleteDirPermissionsRsp";
  }
  protected:
  explicit DeleteDirPermissionsRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.DeleteDirPermissionsRsp)
 private:
  class _Internal;
...
class DeleteFilePermissionsRqst PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.DeleteFilePermissionsRqst) */ {
 public:
  inline DeleteFilePermissionsRqst() : DeleteFilePermissionsRqst(nullptr) {}
  virtual ~DeleteFilePermissionsRqst();

  DeleteFilePermissionsRqst(const DeleteFilePermissionsRqst& from);
  DeleteFilePermissionsRqst(DeleteFilePermissionsRqst&& from) noexcept
    : DeleteFilePermissionsRqst() {
    *this = ::std::move(from);
  }

  inline DeleteFilePermissionsRqst& operator=(const DeleteFilePermissionsRqst& from) {
    CopyFrom(from);
    return *this;
  }
  inline DeleteFilePermissionsRqst& operator=(DeleteFilePermissionsRqst&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DeleteFilePermissionsRqst& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DeleteFilePermissionsRqst* internal_default_instance() {
    return reinterpret_cast<const DeleteFilePermissionsRqst*>(
  ...
  inline void Swap(DeleteFilePermissionsRqst* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(DeleteFilePermissionsRqst* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline DeleteFilePermissionsRqst* New() const final {
    return CreateMaybeMessage<DeleteFilePermissionsRqst>(nullptr);
  }

  DeleteFilePermissionsRqst* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DeleteFilePermissionsRqst>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DeleteFilePermissionsRqst& from);
  void MergeFrom(const DeleteFilePermissionsRqst& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DeleteFilePermissionsRqst* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.DeleteFilePermissionsRqst";
  }
  protected:
  explicit DeleteFilePermissionsRqst(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ressource.DeleteFilePermissionsRqst)
 private:
  class _Internal;
...
class DeleteFilePermissionsRsp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ressource.DeleteFilePermissionsRsp) */ {
 public:
  inline DeleteFilePermissionsRsp() : DeleteFilePermissionsRsp(nullptr) {}
  virtual ~DeleteFilePermissionsRsp();

  DeleteFilePermissionsRsp(const DeleteFilePermissionsRsp& from);
  DeleteFilePermissionsRsp(DeleteFilePermissionsRsp&& from) noexcept
    : DeleteFilePermissionsRsp() {
    *this = ::std::move(from);
  }

  inline DeleteFilePermissionsRsp& operator=(const DeleteFilePermissionsRsp& from) {
    CopyFrom(from);
    return *this;
  }
  inline DeleteFilePermissionsRsp& operator=(DeleteFilePermissionsRsp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DeleteFilePermissionsRsp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DeleteFilePermissionsRsp* internal_default_instance() {
    return reinterpret_cast<const DeleteFilePermissionsRsp*>(
  ...
  inline void Swap(DeleteFilePermissionsRsp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(DeleteFilePermissionsRsp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline DeleteFilePermissionsRsp* New() const final {
    return CreateMaybeMessage<DeleteFilePermissionsRsp>(nullptr);
  }

  DeleteFilePermissionsRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DeleteFilePermissionsRsp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DeleteFilePermissionsRsp& from);
  void MergeFrom(const DeleteFilePermissionsRsp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DeleteFilePermissionsRsp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ressource.DeleteFilePermissionsRsp";
  }
  protected:
  explicit DeleteFilePermissionsRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
// string token = 1;
inline void CreateDirPermissionsRqst::clear_token() {
  token_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& CreateDirPermissionsRqst::token() const {
  // @@protoc_insertion_point(field_get:ressource.CreateDirPermissionsRqst.token)
  return _internal_token();
}
inline void CreateDirPermissionsRqst::set_token(const std::string& value) {
  _internal_set_token(value);
  // @@protoc_insertion_point(field_set:ressource.CreateDirPermissionsRqst.token)
}
inline std::string* CreateDirPermissionsRqst::mutable_token() {
  // @@protoc_insertion_point(field_mutable:ressource.CreateDirPermissionsRqst.token)
  return _internal_mutable_token();
}
inline const std::string& CreateDirPermissionsRqst::_internal_token() const {
  return token_.Get();
}
inline void CreateDirPermissionsRqst::_internal_set_token(const std::string& value) {
  
  token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CreateDirPermissionsRqst::set_token(std::string&& value) {
  
  token_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.CreateDirPermissionsRqst.token)
}
inline void CreateDirPermissionsRqst::set_token(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.CreateDirPermissionsRqst.token)
}
inline void CreateDirPermissionsRqst::set_token(const char* value,
    size_t size) {
  ...
  token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.CreateDirPermissionsRqst.token)
}
inline std::string* CreateDirPermissionsRqst::_internal_mutable_token() {
  
  return token_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CreateDirPermissionsRqst::release_token() {
  // @@protoc_insertion_point(field_release:ressource.CreateDirPermissionsRqst.token)
  return token_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CreateDirPermissionsRqst::set_allocated_token(std::string* token) {
  if (token != nullptr) {
  ...
  token_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), token,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.CreateDirPermissionsRqst.token)
}

// string path = 2;
inline void CreateDirPermissionsRqst::clear_path() {
  path_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& CreateDirPermissionsRqst::path() const {
  // @@protoc_insertion_point(field_get:ressource.CreateDirPermissionsRqst.path)
  return _internal_path();
}
inline void CreateDirPermissionsRqst::set_path(const std::string& value) {
  _internal_set_path(value);
  // @@protoc_insertion_point(field_set:ressource.CreateDirPermissionsRqst.path)
}
inline std::string* CreateDirPermissionsRqst::mutable_path() {
  // @@protoc_insertion_point(field_mutable:ressource.CreateDirPermissionsRqst.path)
  return _internal_mutable_path();
}
inline const std::string& CreateDirPermissionsRqst::_internal_path() const {
  return path_.Get();
}
inline void CreateDirPermissionsRqst::_internal_set_path(const std::string& value) {
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CreateDirPermissionsRqst::set_path(std::string&& value) {
  
  path_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.CreateDirPermissionsRqst.path)
}
inline void CreateDirPermissionsRqst::set_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.CreateDirPermissionsRqst.path)
}
inline void CreateDirPermissionsRqst::set_path(const char* value,
    size_t size) {
  ...
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.CreateDirPermissionsRqst.path)
}
inline std::string* CreateDirPermissionsRqst::_internal_mutable_path() {
  
  return path_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CreateDirPermissionsRqst::release_path() {
  // @@protoc_insertion_point(field_release:ressource.CreateDirPermissionsRqst.path)
  return path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CreateDirPermissionsRqst::set_allocated_path(std::string* path) {
  if (path != nullptr) {
  ...
  path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.CreateDirPermissionsRqst.path)
}

// string name = 3;
inline void CreateDirPermissionsRqst::clear_name() {
  name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& CreateDirPermissionsRqst::name() const {
  // @@protoc_insertion_point(field_get:ressource.CreateDirPermissionsRqst.name)
  return _internal_name();
}
inline void CreateDirPermissionsRqst::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:ressource.CreateDirPermissionsRqst.name)
}
inline std::string* CreateDirPermissionsRqst::mutable_name() {
  // @@protoc_insertion_point(field_mutable:ressource.CreateDirPermissionsRqst.name)
  return _internal_mutable_name();
}
inline const std::string& CreateDirPermissionsRqst::_internal_name() const {
  return name_.Get();
}
inline void CreateDirPermissionsRqst::_internal_set_name(const std::string& value) {
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CreateDirPermissionsRqst::set_name(std::string&& value) {
  
  name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.CreateDirPermissionsRqst.name)
}
inline void CreateDirPermissionsRqst::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.CreateDirPermissionsRqst.name)
}
inline void CreateDirPermissionsRqst::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.CreateDirPermissionsRqst.name)
}
inline std::string* CreateDirPermissionsRqst::_internal_mutable_name() {
  
  return name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CreateDirPermissionsRqst::release_name() {
  // @@protoc_insertion_point(field_release:ressource.CreateDirPermissionsRqst.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CreateDirPermissionsRqst::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.CreateDirPermissionsRqst.name)
}
...
// bool result = 1;
inline void CreateDirPermissionsRsp::clear_result() {
  result_ = false;
}
inline bool CreateDirPermissionsRsp::_internal_result() const {
  return result_;
}
inline bool CreateDirPermissionsRsp::result() const {
  // @@protoc_insertion_point(field_get:ressource.CreateDirPermissionsRsp.result)
  return _internal_result();
}
inline void CreateDirPermissionsRsp::_internal_set_result(bool value) {
  
  result_ = value;
}
inline void CreateDirPermissionsRsp::set_result(bool value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:ressource.CreateDirPermissionsRsp.result)
}
...
// string path = 1;
inline void RenameFilePermissionRqst::clear_path() {
  path_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RenameFilePermissionRqst::path() const {
  // @@protoc_insertion_point(field_get:ressource.RenameFilePermissionRqst.path)
  return _internal_path();
}
inline void RenameFilePermissionRqst::set_path(const std::string& value) {
  _internal_set_path(value);
  // @@protoc_insertion_point(field_set:ressource.RenameFilePermissionRqst.path)
}
inline std::string* RenameFilePermissionRqst::mutable_path() {
  // @@protoc_insertion_point(field_mutable:ressource.RenameFilePermissionRqst.path)
  return _internal_mutable_path();
}
inline const std::string& RenameFilePermissionRqst::_internal_path() const {
  return path_.Get();
}
inline void RenameFilePermissionRqst::_internal_set_path(const std::string& value) {
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RenameFilePermissionRqst::set_path(std::string&& value) {
  
  path_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.RenameFilePermissionRqst.path)
}
inline void RenameFilePermissionRqst::set_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.RenameFilePermissionRqst.path)
}
inline void RenameFilePermissionRqst::set_path(const char* value,
    size_t size) {
  ...
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.RenameFilePermissionRqst.path)
}
inline std::string* RenameFilePermissionRqst::_internal_mutable_path() {
  
  return path_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RenameFilePermissionRqst::release_path() {
  // @@protoc_insertion_point(field_release:ressource.RenameFilePermissionRqst.path)
  return path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RenameFilePermissionRqst::set_allocated_path(std::string* path) {
  if (path != nullptr) {
  ...
  path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.RenameFilePermissionRqst.path)
}

// string oldName = 2;
inline void RenameFilePermissionRqst::clear_oldname() {
  oldname_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RenameFilePermissionRqst::oldname() const {
  // @@protoc_insertion_point(field_get:ressource.RenameFilePermissionRqst.oldName)
  return _internal_oldname();
}
inline void RenameFilePermissionRqst::set_oldname(const std::string& value) {
  _internal_set_oldname(value);
  // @@protoc_insertion_point(field_set:ressource.RenameFilePermissionRqst.oldName)
}
inline std::string* RenameFilePermissionRqst::mutable_oldname() {
  // @@protoc_insertion_point(field_mutable:ressource.RenameFilePermissionRqst.oldName)
  return _internal_mutable_oldname();
}
inline const std::string& RenameFilePermissionRqst::_internal_oldname() const {
  return oldname_.Get();
}
inline void RenameFilePermissionRqst::_internal_set_oldname(const std::string& value) {
  
  oldname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RenameFilePermissionRqst::set_oldname(std::string&& value) {
  
  oldname_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.RenameFilePermissionRqst.oldName)
}
inline void RenameFilePermissionRqst::set_oldname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  oldname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.RenameFilePermissionRqst.oldName)
}
inline void RenameFilePermissionRqst::set_oldname(const char* value,
    size_t size) {
  ...
  oldname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.RenameFilePermissionRqst.oldName)
}
inline std::string* RenameFilePermissionRqst::_internal_mutable_oldname() {
  
  return oldname_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RenameFilePermissionRqst::release_oldname() {
  // @@protoc_insertion_point(field_release:ressource.RenameFilePermissionRqst.oldName)
  return oldname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RenameFilePermissionRqst::set_allocated_oldname(std::string* oldname) {
  if (oldname != nullptr) {
  ...
  oldname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), oldname,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.RenameFilePermissionRqst.oldName)
}

// string newName = 3;
inline void RenameFilePermissionRqst::clear_newname() {
  newname_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RenameFilePermissionRqst::newname() const {
  // @@protoc_insertion_point(field_get:ressource.RenameFilePermissionRqst.newName)
  return _internal_newname();
}
inline void RenameFilePermissionRqst::set_newname(const std::string& value) {
  _internal_set_newname(value);
  // @@protoc_insertion_point(field_set:ressource.RenameFilePermissionRqst.newName)
}
inline std::string* RenameFilePermissionRqst::mutable_newname() {
  // @@protoc_insertion_point(field_mutable:ressource.RenameFilePermissionRqst.newName)
  return _internal_mutable_newname();
}
inline const std::string& RenameFilePermissionRqst::_internal_newname() const {
  return newname_.Get();
}
inline void RenameFilePermissionRqst::_internal_set_newname(const std::string& value) {
  
  newname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RenameFilePermissionRqst::set_newname(std::string&& value) {
  
  newname_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.RenameFilePermissionRqst.newName)
}
inline void RenameFilePermissionRqst::set_newname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  newname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.RenameFilePermissionRqst.newName)
}
inline void RenameFilePermissionRqst::set_newname(const char* value,
    size_t size) {
  ...
  newname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.RenameFilePermissionRqst.newName)
}
inline std::string* RenameFilePermissionRqst::_internal_mutable_newname() {
  
  return newname_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RenameFilePermissionRqst::release_newname() {
  // @@protoc_insertion_point(field_release:ressource.RenameFilePermissionRqst.newName)
  return newname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RenameFilePermissionRqst::set_allocated_newname(std::string* newname) {
  if (newname != nullptr) {
  ...
  newname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), newname,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.RenameFilePermissionRqst.newName)
}
...
// bool result = 1;
inline void RenameFilePermissionRsp::clear_result() {
  result_ = false;
}
inline bool RenameFilePermissionRsp::_internal_result() const {
  return result_;
}
inline bool RenameFilePermissionRsp::result() const {
  // @@protoc_insertion_point(field_get:ressource.RenameFilePermissionRsp.result)
  return _internal_result();
}
inline void RenameFilePermissionRsp::_internal_set_result(bool value) {
  
  result_ = value;
}
inline void RenameFilePermissionRsp::set_result(bool value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:ressource.RenameFilePermissionRsp.result)
}
...
// string path = 1;
inline void DeleteDirPermissionsRqst::clear_path() {
  path_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& DeleteDirPermissionsRqst::path() const {
  // @@protoc_insertion_point(field_get:ressource.DeleteDirPermissionsRqst.path)
  return _internal_path();
}
inline void DeleteDirPermissionsRqst::set_path(const std::string& value) {
  _internal_set_path(value);
  // @@protoc_insertion_point(field_set:ressource.DeleteDirPermissionsRqst.path)
}
inline std::string* DeleteDirPermissionsRqst::mutable_path() {
  // @@protoc_insertion_point(field_mutable:ressource.DeleteDirPermissionsRqst.path)
  return _internal_mutable_path();
}
inline const std::string& DeleteDirPermissionsRqst::_internal_path() const {
  return path_.Get();
}
inline void DeleteDirPermissionsRqst::_internal_set_path(const std::string& value) {
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void DeleteDirPermissionsRqst::set_path(std::string&& value) {
  
  path_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.DeleteDirPermissionsRqst.path)
}
inline void DeleteDirPermissionsRqst::set_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.DeleteDirPermissionsRqst.path)
}
inline void DeleteDirPermissionsRqst::set_path(const char* value,
    size_t size) {
  ...
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.DeleteDirPermissionsRqst.path)
}
inline std::string* DeleteDirPermissionsRqst::_internal_mutable_path() {
  
  return path_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* DeleteDirPermissionsRqst::release_path() {
  // @@protoc_insertion_point(field_release:ressource.DeleteDirPermissionsRqst.path)
  return path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void DeleteDirPermissionsRqst::set_allocated_path(std::string* path) {
  if (path != nullptr) {
  ...
  path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.DeleteDirPermissionsRqst.path)
}
...
// bool result = 1;
inline void DeleteDirPermissionsRsp::clear_result() {
  result_ = false;
}
inline bool DeleteDirPermissionsRsp::_internal_result() const {
  return result_;
}
inline bool DeleteDirPermissionsRsp::result() const {
  // @@protoc_insertion_point(field_get:ressource.DeleteDirPermissionsRsp.result)
  return _internal_result();
}
inline void DeleteDirPermissionsRsp::_internal_set_result(bool value) {
  
  result_ = value;
}
inline void DeleteDirPermissionsRsp::set_result(bool value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:ressource.DeleteDirPermissionsRsp.result)
}
...
// string path = 1;
inline void DeleteFilePermissionsRqst::clear_path() {
  path_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& DeleteFilePermissionsRqst::path() const {
  // @@protoc_insertion_point(field_get:ressource.DeleteFilePermissionsRqst.path)
  return _internal_path();
}
inline void DeleteFilePermissionsRqst::set_path(const std::string& value) {
  _internal_set_path(value);
  // @@protoc_insertion_point(field_set:ressource.DeleteFilePermissionsRqst.path)
}
inline std::string* DeleteFilePermissionsRqst::mutable_path() {
  // @@protoc_insertion_point(field_mutable:ressource.DeleteFilePermissionsRqst.path)
  return _internal_mutable_path();
}
inline const std::string& DeleteFilePermissionsRqst::_internal_path() const {
  return path_.Get();
}
inline void DeleteFilePermissionsRqst::_internal_set_path(const std::string& value) {
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void DeleteFilePermissionsRqst::set_path(std::string&& value) {
  
  path_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ressource.DeleteFilePermissionsRqst.path)
}
inline void DeleteFilePermissionsRqst::set_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ressource.DeleteFilePermissionsRqst.path)
}
inline void DeleteFilePermissionsRqst::set_path(const char* value,
    size_t size) {
  ...
  path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ressource.DeleteFilePermissionsRqst.path)
}
inline std::string* DeleteFilePermissionsRqst::_internal_mutable_path() {
  
  return path_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* DeleteFilePermissionsRqst::release_path() {
  // @@protoc_insertion_point(field_release:ressource.DeleteFilePermissionsRqst.path)
  return path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void DeleteFilePermissionsRqst::set_allocated_path(std::string* path) {
  if (path != nullptr) {
  ...
  path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ressource.DeleteFilePermissionsRqst.path)
}
...
// bool result = 1;
inline void DeleteFilePermissionsRsp::clear_result() {
  result_ = false;
}
inline bool DeleteFilePermissionsRsp::_internal_result() const {
  return result_;
}
inline bool DeleteFilePermissionsRsp::result() const {
  // @@protoc_insertion_point(field_get:ressource.DeleteFilePermissionsRsp.result)
  return _internal_result();
}
inline void DeleteFilePermissionsRsp::_internal_set_result(bool value) {
  
  result_ = value;
}
inline void DeleteFilePermissionsRsp::set_result(bool value) {
  _internal_set_result(value);
