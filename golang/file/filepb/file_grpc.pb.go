...
type FileServiceClient interface {
	...
	UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (FileService_UploadFileClient, error)
	// Write an Excel file.
...
func (c *fileServiceClient) ReadDir(ctx context.Context, in *ReadDirRequest, opts ...grpc.CallOption) (FileService_ReadDirClient, error) {
	...
	x := &fileServiceReadDirClient{ClientStream: stream}
...
func (c *fileServiceClient) ReadFile(ctx context.Context, in *ReadFileRequest, opts ...grpc.CallOption) (FileService_ReadFileClient, error) {
	...
	x := &fileServiceReadFileClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *fileServiceClient) SaveFile(ctx context.Context, opts ...grpc.CallOption) (FileService_SaveFileClient, error) {
	...
	x := &fileServiceSaveFileClient{ClientStream: stream}
	return x, nil
}
...
func (c *fileServiceClient) GetThumbnails(ctx context.Context, in *GetThumbnailsRequest, opts ...grpc.CallOption) (FileService_GetThumbnailsClient, error) {
	...
	x := &fileServiceGetThumbnailsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *fileServiceClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (FileService_UploadFileClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type FileServiceServer interface {
	...
	// Upload a file from a URL.
	UploadFile(*UploadFileRequest, FileService_UploadFileServer) error
	// Write an Excel file.
...
func (UnimplementedFileServiceServer) UploadFile(*UploadFileRequest, FileService_UploadFileServer) error {
...
func _FileService_ReadDir_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).ReadDir(m, &fileServiceReadDirServer{ServerStream: stream})
}
...
func _FileService_ReadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).ReadFile(m, &fileServiceReadFileServer{ServerStream: stream})
}
...
func _FileService_SaveFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(FileServiceServer).SaveFile(&fileServiceSaveFileServer{ServerStream: stream})
}
...
func _FileService_GetThumbnails_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).GetThumbnails(m, &fileServiceGetThumbnailsServer{ServerStream: stream})
}
...
func _FileService_UploadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FileServiceServer).UploadFile(m, &fileServiceUploadFileServer{ServerStream: stream})
}
