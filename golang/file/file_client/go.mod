module github.com/globulario/services/golang/file/file_client
...
replace github.com/globulario/services/golang/file/filepb => ../filepb
...
require (
	...
	github.com/globulario/services/golang/file/filepb v0.0.0-00010101000000-000000000000
