...
func TestResolveByBuildIDAbsent_ReturnsNotFound(t *testing.T) {
...
func TestDeletionSafety_DesiredBuildID_IsBlocked(t *testing.T) {
	TestReachability_DesiredBuildID_IsHardRoot(t)
}
func TestRevokeSafety_DesiredBuildID_IsBlocked(t *testing.T) {
	TestReachability_DesiredBuildID_IsHardRoot(t)
}
...
func TestMetadataReadsDegradedMode(t *testing.T) {
	TestGetRepositoryStatus_NilWatchdog_ReturnsDegraded(t)
}
...
func TestReconcilerNoDowngradeWithoutForce(t *testing.T) {
	TestVersionImmutabilityRunsAfterDigestIdempotency(t)
}
