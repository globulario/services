...
var file_rbac_proto_rawDesc = []byte{
	...
	0x04, 0x12, 0x08, 0x0a, 0x04, 0x52, 0x4f, 0x4c, 0x45, 0x10, 0x05, 0x32, 0xde, 0x0a, 0x0a, 0x0b,
	...
	0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x73, 0x70, 0x42, 0x0d, 0x5a, 0x0b,
	0x72, 0x62, 0x61, 0x63, 0x2f, 0x72, 0x62, 0x61, 0x63, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_rbac_proto_depIdxs = []int32{
	...
	38, // 18: rbac.SetActionResourcesPermissionsRqst.permissions:type_name -> google.protobuf.Struct
	...
	10, // 23: rbac.RbacService.SetResourcePermissions:input_type -> rbac.SetResourcePermissionsRqst
	6,  // 24: rbac.RbacService.DeleteResourcePermissions:input_type -> rbac.DeleteResourcePermissionsRqst
	8,  // 25: rbac.RbacService.DeleteResourcePermission:input_type -> rbac.DeleteResourcePermissionRqst
	12, // 26: rbac.RbacService.GetResourcePermission:input_type -> rbac.GetResourcePermissionRqst
	14, // 27: rbac.RbacService.SetResourcePermission:input_type -> rbac.SetResourcePermissionRqst
	4,  // 28: rbac.RbacService.GetResourcePermissions:input_type -> rbac.GetResourcePermissionsRqst
	16, // 29: rbac.RbacService.AddResourceOwner:input_type -> rbac.AddResourceOwnerRqst
	18, // 30: rbac.RbacService.RemoveResourceOwner:input_type -> rbac.RemoveResourceOwnerRqst
	20, // 31: rbac.RbacService.DeleteAllAccess:input_type -> rbac.DeleteAllAccessRqst
	22, // 32: rbac.RbacService.ValidateAccess:input_type -> rbac.ValidateAccessRqst
	29, // 33: rbac.RbacService.SetActionResourcesPermissions:input_type -> rbac.SetActionResourcesPermissionsRqst
	24, // 34: rbac.RbacService.GetActionResourceInfos:input_type -> rbac.GetActionResourceInfosRqst
	27, // 35: rbac.RbacService.ValidateAction:input_type -> rbac.ValidateActionRqst
	32, // 36: rbac.RbacService.ShareResource:input_type -> rbac.ShareResourceRqst
	34, // 37: rbac.RbacService.UshareResource:input_type -> rbac.UnshareResourceRqst
	36, // 38: rbac.RbacService.GetSharedResource:input_type -> rbac.GetSharedResourceRqst
	10, // 39: rbac.RbacService.SetResourcePermissions:output_type -> rbac.SetResourcePermissionsRqst
	6,  // 40: rbac.RbacService.DeleteResourcePermissions:output_type -> rbac.DeleteResourcePermissionsRqst
	8,  // 41: rbac.RbacService.DeleteResourcePermission:output_type -> rbac.DeleteResourcePermissionRqst
	13, // 42: rbac.RbacService.GetResourcePermission:output_type -> rbac.GetResourcePermissionRsp
	15, // 43: rbac.RbacService.SetResourcePermission:output_type -> rbac.SetResourcePermissionRsp
	5,  // 44: rbac.RbacService.GetResourcePermissions:output_type -> rbac.GetResourcePermissionsRsp
	17, // 45: rbac.RbacService.AddResourceOwner:output_type -> rbac.AddResourceOwnerRsp
	19, // 46: rbac.RbacService.RemoveResourceOwner:output_type -> rbac.RemoveResourceOwnerRsp
	21, // 47: rbac.RbacService.DeleteAllAccess:output_type -> rbac.DeleteAllAccessRsp
	23, // 48: rbac.RbacService.ValidateAccess:output_type -> rbac.ValidateAccessRsp
	30, // 49: rbac.RbacService.SetActionResourcesPermissions:output_type -> rbac.SetActionResourcesPermissionsRsp
	26, // 50: rbac.RbacService.GetActionResourceInfos:output_type -> rbac.GetActionResourceInfosRsp
	28, // 51: rbac.RbacService.ValidateAction:output_type -> rbac.ValidateActionRsp
	33, // 52: rbac.RbacService.ShareResource:output_type -> rbac.ShareResourceRsp
	35, // 53: rbac.RbacService.UshareResource:output_type -> rbac.UnshareResourceRsp
	37, // 54: rbac.RbacService.GetSharedResource:output_type -> rbac.GetSharedResourceRsp
