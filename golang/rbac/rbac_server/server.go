...
////////////////////////////////////////////////////////////////////////////////////////
func (svr *server) getAccountById(id string) (map[string]interface{}, error) {
	return nil, errors.New("not implemented")
}

func (svr *server) getGroupById(id string) (map[string]interface{}, error) {
	return nil, errors.New("not implemented")
}

func (svr *server) getApplicationById(id string) (map[string]interface{}, error) {
	return nil, errors.New("not implemented")
}

func (svr *server) getPeerById(id string) (map[string]interface{}, error) {
	return nil, errors.New("not implemented")
}

func (svr *server) getRoleById(id string) (map[string]interface{}, error) {
	return nil, errors.New("not implemented")
}
...
func main() {
	...
	s_impl := new(server)
	s_impl.Name = string(rbacpb.File_proto_rbac_proto.Services().Get(0).FullName())
	s_impl.Proto = rbacpb.File_proto_rbac_proto.Path()
