...
func (r *ReleaseResolver) Resolve(ctx context.Context, spec *cluster_controllerpb.ServiceReleaseSpec) (exactVersion, digest string, err error) {
	if spec == nil {
...
func (r *ReleaseResolver) getLatestByChannel(_ context.Context, client *repository_client.Repository_Service_Client, spec *cluster_controllerpb.ServiceReleaseSpec, channel string) (string, error) {
