...
func (srv *server) DeployControlPlanePackage(ctx context.Context, req *cluster_controllerpb.DeployControlPlanePackageRequest) (*cluster_controllerpb.DeployControlPlanePackageResponse, error) {
	...
	if srv.getWorkflowClient() == nil {
		return reject("workflow service not reachable"), nil
	}
	...
	go func() {
		err := srv.RunControllerDeployWorkflow(srv.getLeaderCtx(), pkgName, pkgKind, version, resolvedBuild, resolved.EntrypointChecksum)
		if err != nil {
