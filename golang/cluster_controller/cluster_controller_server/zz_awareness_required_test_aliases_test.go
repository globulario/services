...
func TestRuntimeStatus_NotDerivedFromDesiredState(t *testing.T) {
	TestRuntimeHealthSeparateFromInstalled(t)
}
...
func TestControllerRollout_PartialNotConverged(t *testing.T) {
	TestHasUnservedNodes_VersionMatchButRuntimeInactive(t)
}
...
func TestDay1RefusesReadyWhenBundleMissing(t *testing.T) {
	TestBootstrapAwarenessReadyTimesOutGracefully(t)
}
...
func TestDay1SpecHasStartServicesStep(t *testing.T) {
	TestNodeJoinWorkflowIncludesRepoInstallableProfilePackages(t)
}
func TestJoinDoesNotRequireFoundingQuorum(t *testing.T) {
	TestJoinAuthorization_DefaultProfilesAreNotQuorumCoerced(t)
}
func TestHealthVersion_RequiresRuntimeProof(t *testing.T) {
	TestDecideVersionVerdict_BuildIdsMatch_NoProof_DegradedUnverified(t)
}
func TestHealthVersion_PartialProofIsDegraded(t *testing.T) {
	TestDecideVersionVerdict_VerifierUnknown_DegradesToUnverified(t)
}
...
func TestRemoveStaleMembers_VIPHolder_NotEvicted(t *testing.T) {
	TestMinioJoin_VIPHolder_MatchesByAnyIP(t)
}
...
func TestLeaderView_ShowsStableNodeIP_NotVIP(t *testing.T) {
	TestSnapshotClusterMembershipUsesStableIP(t)
}
func TestMembershipView_DistinguishesVIP_FromNodeIP(t *testing.T) {
	TestSnapshotClusterMembershipUsesStableIP(t)
}
...
func TestSetNodeProfilesDoesNotEnforceStorageCountFloor(t *testing.T) {
	TestTopologyPreflightDoesNotEnforceStorageCountFloor(t)
}
...
func TestControllerProbsServiceInterfaceNotJustTCP(t *testing.T) {
	TestResolveIntent_TransitiveDependencyExpansion(t)
}
