...
type Store interface {
	...
	UpdateStatus(ctx context.Context, typ, name string, status *cluster_controllerpb.ObjectStatus) (interface{}, error)
}
...
func (s *memStore) Apply(ctx context.Context, typ string, obj interface{}) (interface{}, error) {
	...
	if status == nil {
		setStatus(obj, &cluster_controllerpb.ObjectStatus{})
		status = extractStatus(obj)
	}
	res := &storedResource{
		obj:        deepCopy(obj),
...
func (s *memStore) UpdateStatus(ctx context.Context, typ, name string, status *cluster_controllerpb.ObjectStatus) (interface{}, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	objs := s.objects[typ]
	if objs == nil {
...
func extractMeta(obj interface{}) *cluster_controllerpb.ObjectMeta {
	switch o := obj.(type) {
	case *cluster_controllerpb.ClusterNetwork:
		return o.Meta
	case *cluster_controllerpb.ServiceDesiredVersion:
		return o.Meta
...
func extractStatus(obj interface{}) *cluster_controllerpb.ObjectStatus {
	switch o := obj.(type) {
	case *cluster_controllerpb.ClusterNetwork:
		return o.Status
	case *cluster_controllerpb.ServiceDesiredVersion:
...
func setStatus(obj interface{}, st *cluster_controllerpb.ObjectStatus) {
	switch o := obj.(type) {
	case *cluster_controllerpb.ClusterNetwork:
		o.Status = st
	case *cluster_controllerpb.ServiceDesiredVersion:
...
func deepCopy(obj interface{}) interface{} {
	...
	switch obj.(type) {
	case *cluster_controllerpb.ClusterNetwork:
		tmp := &cluster_controllerpb.ClusterNetwork{}
		_ = json.Unmarshal(b, tmp)
		dst = tmp
	case *cluster_controllerpb.ServiceDesiredVersion:
		tmp := &cluster_controllerpb.ServiceDesiredVersion{}
		_ = json.Unmarshal(b, tmp)
		dst = tmp
	case *cluster_controllerpb.Node:
		tmp := &cluster_controllerpb.Node{}
		_ = json.Unmarshal(b, tmp)
		dst = tmp
	case *cluster_controllerpb.ServiceRelease:
