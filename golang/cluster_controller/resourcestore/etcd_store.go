...
func (s *etcdStore) UpdateStatus(ctx context.Context, typ, name string, status *cluster_controllerpb.ObjectStatus) (interface{}, error) {
...
func decodeObject(typ string, data []byte) (interface{}, error) {
	switch typ {
	case "ClusterNetwork":
		obj := &cluster_controllerpb.ClusterNetwork{}
	...
	case "ApplicationRelease":
		obj := &cluster_controllerpb.ApplicationRelease{}
		if err := json.Unmarshal(data, obj); err != nil {
			return nil, err
		}
		return obj, nil
