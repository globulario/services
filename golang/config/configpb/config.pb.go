...
func (x *SetServiceConfigurationRequest) GetConfig() *_struct.Struct {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *GetServiceConfigurationResponse) GetConfig() *_struct.Struct {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *GetServiceConfigurationByIdResponse) GetConfig() *_struct.Struct {
	if x != nil {
		return x.Config
	}
	return nil
...
type GetServicesConfigurationsByNameResponse struct {
	...
	Configs []*_struct.Struct `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}
...
func (x *GetServicesConfigurationsByNameResponse) GetConfigs() []*_struct.Struct {
	if x != nil {
		return x.Configs
	}
	return nil
...
func (x *GetServicesConfigurationsResponse) GetConfigs() []*_struct.Struct {
	if x != nil {
		return x.Configs
	}
	return nil
...
var file_config_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x32, 0xe0, 0x04, 0x0a, 0x0d, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x6c, 0x0a, 0x17,
...
var file_config_proto_depIdxs = []int32{
	...
	10, // 1: config.GetServiceConfigurationResponse.config:type_name -> google.protobuf.Struct
	10, // 2: config.GetServiceConfigurationByIdResponse.config:type_name -> google.protobuf.Struct
	10, // 3: config.GetServicesConfigurationsByNameResponse.configs:type_name -> google.protobuf.Struct
	10, // 4: config.GetServicesConfigurationsResponse.configs:type_name -> google.protobuf.Struct
	0,  // 5: config.ConfigService.SetServiceConfiguration:input_type -> config.SetServiceConfigurationRequest
	2,  // 6: config.ConfigService.GetServiceConfiguration:input_type -> config.GetServiceConfigurationRequest
	4,  // 7: config.ConfigService.GetServiceConfigurationById:input_type -> config.GetServiceConfigurationByIdRequest
	6,  // 8: config.ConfigService.GetServicesConfigurationsByName:input_type -> config.GetServicesConfigurationsByNameRequest
	8,  // 9: config.ConfigService.GetServicesConfigurations:input_type -> config.GetServicesConfigurationsRequest
	1,  // 10: config.ConfigService.SetServiceConfiguration:output_type -> config.SetServiceConfigurationResponse
	3,  // 11: config.ConfigService.GetServiceConfiguration:output_type -> config.GetServiceConfigurationResponse
	5,  // 12: config.ConfigService.GetServiceConfigurationById:output_type -> config.GetServiceConfigurationByIdResponse
	7,  // 13: config.ConfigService.GetServicesConfigurationsByName:output_type -> config.GetServicesConfigurationsByNameResponse
	9,  // 14: config.ConfigService.GetServicesConfigurations:output_type -> config.GetServicesConfigurationsResponse
