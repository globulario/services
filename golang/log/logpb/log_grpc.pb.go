...
type LogServiceClient interface {
	...
	GetLog(ctx context.Context, in *GetLogRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetLogRsp], error)
...
func (c *logServiceClient) GetLog(ctx context.Context, in *GetLogRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetLogRsp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LogService_ServiceDesc.Streams[0], LogService_GetLog_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetLogRqst, GetLogRsp]{ClientStream: stream}
...
type LogService_GetLogClient = grpc.ServerStreamingClient[GetLogRsp]
...
type LogServiceServer interface {
	...
	// Retrieves log entries based on a query.
	// This is a server streaming RPC where the response is a stream of messages.
	GetLog(*GetLogRqst, grpc.ServerStreamingServer[GetLogRsp]) error
	// Deletes a specific log entry.
...
func (UnimplementedLogServiceServer) GetLog(*GetLogRqst, grpc.ServerStreamingServer[GetLogRsp]) error {
...
func (UnimplementedLogServiceServer) ClearAllLog(context.Context, *ClearAllLogRqst) (*ClearAllLogRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearAllLog not implemented")
}
...
func _LogService_GetLog_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LogServiceServer).GetLog(m, &grpc.GenericServerStream[GetLogRqst, GetLogRsp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LogService_GetLogServer = grpc.ServerStreamingServer[GetLogRsp]
