module github.com/globulario/services/golang/log/log_client
...
replace github.com/globulario/services/golang/log/logpb => ../logpb
...
require (
	...
	github.com/globulario/services/golang/log/logpb v0.0.0-00010101000000-000000000000
