...
func printUsage() {
	...
	fmt.Println("  log-service --debug")
	fmt.Println()
	fmt.Println("  # Check service version")
	fmt.Println("  log-service --version")
	fmt.Println()
	fmt.Println("  # Start with custom service ID")
	fmt.Println("  log-service my-log-instance")
	fmt.Println()
	fmt.Println("  # Start with custom domain via environment")
	fmt.Println("  GLOBULAR_DOMAIN=example.com log-service")
}
