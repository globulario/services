...
// UnimplementedPlcServiceServer can be embedded to have forward compatible implementations.
...
func RegisterPlcServiceServer(s *grpc.Server, srv PlcServiceServer) {
	s.RegisterService(&_PlcService_serviceDesc, srv)
}
...
var _PlcService_serviceDesc = grpc.ServiceDesc{
