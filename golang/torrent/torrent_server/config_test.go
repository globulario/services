...
func TestDefaultConfigValidates(t *testing.T) {
	cfg := DefaultConfig()
	if cfg.Name != "torrent.TorrentService" {
		t.Fatalf("Name=%q want torrent.TorrentService", cfg.Name)
	}
...
func TestConfigFileRoundTrip(t *testing.T) {
	...
	if loaded.ID != cfg.ID || loaded.Address != cfg.Address || loaded.DownloadDir != cfg.DownloadDir {
