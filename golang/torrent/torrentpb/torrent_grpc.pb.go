...
func (UnimplementedTorrentServiceServer) GetTorrentInfos(*GetTorrentInfosRequest, grpc.ServerStreamingServer[GetTorrentInfosResponse]) error {
	return status.Error(codes.Unimplemented, "method GetTorrentInfos not implemented")
}
func (UnimplementedTorrentServiceServer) DropTorrent(context.Context, *DropTorrentRequest) (*DropTorrentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DropTorrent not implemented")
}
func (UnimplementedTorrentServiceServer) GetTorrentLnks(context.Context, *GetTorrentLnksRequest) (*GetTorrentLnksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTorrentLnks not implemented")
}
