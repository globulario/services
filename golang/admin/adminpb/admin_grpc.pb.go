...
type AdminServiceClient interface {
	...
	Update(ctx context.Context, opts ...grpc.CallOption) (AdminService_UpdateClient, error)
	// Downloads the Globular executable file for specified platform.
	DownloadGlobular(ctx context.Context, in *DownloadGlobularRequest, opts ...grpc.CallOption) (AdminService_DownloadGlobularClient, error)
	...
	GetProcessInfos(ctx context.Context, in *GetProcessInfosRequest, opts ...grpc.CallOption) (AdminService_GetProcessInfosClient, error)
	// Executes an external command on the server and returns its output.
	RunCmd(ctx context.Context, in *RunCmdRequest, opts ...grpc.CallOption) (AdminService_RunCmdClient, error)
...
func (c *adminServiceClient) Update(ctx context.Context, opts ...grpc.CallOption) (AdminService_UpdateClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[0], AdminService_Update_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &adminServiceUpdateClient{ClientStream: stream}
	return x, nil
}

type AdminService_UpdateClient interface {
	Send(*UpdateRequest) error
	CloseAndRecv() (*UpdateResponse, error)
	grpc.ClientStream
}

type adminServiceUpdateClient struct {
	grpc.ClientStream
}

func (x *adminServiceUpdateClient) Send(m *UpdateRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *adminServiceUpdateClient) CloseAndRecv() (*UpdateResponse, error) {
...
func (c *adminServiceClient) DownloadGlobular(ctx context.Context, in *DownloadGlobularRequest, opts ...grpc.CallOption) (AdminService_DownloadGlobularClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[1], AdminService_DownloadGlobular_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &adminServiceDownloadGlobularClient{ClientStream: stream}
...
type AdminService_DownloadGlobularClient interface {
	Recv() (*DownloadGlobularResponse, error)
	grpc.ClientStream
}

type adminServiceDownloadGlobularClient struct {
	grpc.ClientStream
}

func (x *adminServiceDownloadGlobularClient) Recv() (*DownloadGlobularResponse, error) {
	m := new(DownloadGlobularResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *adminServiceClient) GetProcessInfos(ctx context.Context, in *GetProcessInfosRequest, opts ...grpc.CallOption) (AdminService_GetProcessInfosClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[2], AdminService_GetProcessInfos_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &adminServiceGetProcessInfosClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AdminService_GetProcessInfosClient interface {
	Recv() (*GetProcessInfosResponse, error)
	grpc.ClientStream
}

type adminServiceGetProcessInfosClient struct {
	grpc.ClientStream
}

func (x *adminServiceGetProcessInfosClient) Recv() (*GetProcessInfosResponse, error) {
	m := new(GetProcessInfosResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *adminServiceClient) RunCmd(ctx context.Context, in *RunCmdRequest, opts ...grpc.CallOption) (AdminService_RunCmdClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[3], AdminService_RunCmd_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &adminServiceRunCmdClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AdminService_RunCmdClient interface {
	Recv() (*RunCmdResponse, error)
	grpc.ClientStream
}

type adminServiceRunCmdClient struct {
	grpc.ClientStream
}

func (x *adminServiceRunCmdClient) Recv() (*RunCmdResponse, error) {
...
type AdminServiceServer interface {
	// Updates a specific Globular server. Typically used via command line interface.
	Update(AdminService_UpdateServer) error
	// Downloads the Globular executable file for specified platform.
	DownloadGlobular(*DownloadGlobularRequest, AdminService_DownloadGlobularServer) error
	// Retrieves public SSL/TLS certificates for a given domain from a server.
	...
	// Fetches detailed information about processes, either all or filtered by name or PID.
	GetProcessInfos(*GetProcessInfosRequest, AdminService_GetProcessInfosServer) error
	// Executes an external command on the server and returns its output.
	RunCmd(*RunCmdRequest, AdminService_RunCmdServer) error
	// Sets an environment variable on the server with the specified name and value.
...
func (UnimplementedAdminServiceServer) Update(AdminService_UpdateServer) error {
	return status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedAdminServiceServer) DownloadGlobular(*DownloadGlobularRequest, AdminService_DownloadGlobularServer) error {
...
func (UnimplementedAdminServiceServer) GetProcessInfos(*GetProcessInfosRequest, AdminService_GetProcessInfosServer) error {
	return status.Errorf(codes.Unimplemented, "method GetProcessInfos not implemented")
}
func (UnimplementedAdminServiceServer) RunCmd(*RunCmdRequest, AdminService_RunCmdServer) error {
...
func _AdminService_Update_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AdminServiceServer).Update(&adminServiceUpdateServer{ServerStream: stream})
}

type AdminService_UpdateServer interface {
	SendAndClose(*UpdateResponse) error
	Recv() (*UpdateRequest, error)
	grpc.ServerStream
}

type adminServiceUpdateServer struct {
	grpc.ServerStream
}

func (x *adminServiceUpdateServer) SendAndClose(m *UpdateResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *adminServiceUpdateServer) Recv() (*UpdateRequest, error) {
	m := new(UpdateRequest)
...
func _AdminService_DownloadGlobular_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AdminServiceServer).DownloadGlobular(m, &adminServiceDownloadGlobularServer{ServerStream: stream})
}

type AdminService_DownloadGlobularServer interface {
	Send(*DownloadGlobularResponse) error
	grpc.ServerStream
}

type adminServiceDownloadGlobularServer struct {
	grpc.ServerStream
}

func (x *adminServiceDownloadGlobularServer) Send(m *DownloadGlobularResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _AdminService_GetProcessInfos_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AdminServiceServer).GetProcessInfos(m, &adminServiceGetProcessInfosServer{ServerStream: stream})
}

type AdminService_GetProcessInfosServer interface {
	Send(*GetProcessInfosResponse) error
	grpc.ServerStream
}

type adminServiceGetProcessInfosServer struct {
	grpc.ServerStream
}

func (x *adminServiceGetProcessInfosServer) Send(m *GetProcessInfosResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _AdminService_RunCmd_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AdminServiceServer).RunCmd(m, &adminServiceRunCmdServer{ServerStream: stream})
}

type AdminService_RunCmdServer interface {
	Send(*RunCmdResponse) error
	grpc.ServerStream
}

type adminServiceRunCmdServer struct {
	grpc.ServerStream
}

func (x *adminServiceRunCmdServer) Send(m *RunCmdResponse) error {
	return x.ServerStream.SendMsg(m)
}
