...
type ResourceServiceClient interface {
	...
	GetOrganizations(ctx context.Context, in *GetOrganizationsRqst, opts ...grpc.CallOption) (ResourceService_GetOrganizationsClient, error)
	...
	GetGroups(ctx context.Context, in *GetGroupsRqst, opts ...grpc.CallOption) (ResourceService_GetGroupsClient, error)
	// Deletes a group.
	...
	GetAccounts(ctx context.Context, in *GetAccountsRqst, opts ...grpc.CallOption) (ResourceService_GetAccountsClient, error)
	...
	GetRoles(ctx context.Context, in *GetRolesRqst, opts ...grpc.CallOption) (ResourceService_GetRolesClient, error)
	...
	GetApplications(ctx context.Context, in *GetApplicationsRqst, opts ...grpc.CallOption) (ResourceService_GetApplicationsClient, error)
	...
	GetPeers(ctx context.Context, in *GetPeersRqst, opts ...grpc.CallOption) (ResourceService_GetPeersClient, error)
	...
	GetNotifications(ctx context.Context, in *GetNotificationsRqst, opts ...grpc.CallOption) (ResourceService_GetNotificationsClient, error)
	...
	GetPackagesDescriptor(ctx context.Context, in *GetPackagesDescriptorRequest, opts ...grpc.CallOption) (ResourceService_GetPackagesDescriptorClient, error)
...
func (c *resourceServiceClient) GetOrganizations(ctx context.Context, in *GetOrganizationsRqst, opts ...grpc.CallOption) (ResourceService_GetOrganizationsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &resourceServiceGetOrganizationsClient{ClientStream: stream}
...
type ResourceService_GetOrganizationsClient interface {
	Recv() (*GetOrganizationsRsp, error)
	grpc.ClientStream
}

type resourceServiceGetOrganizationsClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetOrganizationsClient) Recv() (*GetOrganizationsRsp, error) {
	m := new(GetOrganizationsRsp)
...
func (c *resourceServiceClient) GetGroups(ctx context.Context, in *GetGroupsRqst, opts ...grpc.CallOption) (ResourceService_GetGroupsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceService_ServiceDesc.Streams[1], ResourceService_GetGroups_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &resourceServiceGetGroupsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetGroupsClient interface {
	Recv() (*GetGroupsRsp, error)
	grpc.ClientStream
}

type resourceServiceGetGroupsClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetGroupsClient) Recv() (*GetGroupsRsp, error) {
	m := new(GetGroupsRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *resourceServiceClient) GetAccounts(ctx context.Context, in *GetAccountsRqst, opts ...grpc.CallOption) (ResourceService_GetAccountsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceService_ServiceDesc.Streams[2], ResourceService_GetAccounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &resourceServiceGetAccountsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetAccountsClient interface {
	Recv() (*GetAccountsRsp, error)
	grpc.ClientStream
}

type resourceServiceGetAccountsClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetAccountsClient) Recv() (*GetAccountsRsp, error) {
	m := new(GetAccountsRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *resourceServiceClient) GetRoles(ctx context.Context, in *GetRolesRqst, opts ...grpc.CallOption) (ResourceService_GetRolesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceService_ServiceDesc.Streams[3], ResourceService_GetRoles_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &resourceServiceGetRolesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetRolesClient interface {
	Recv() (*GetRolesRsp, error)
	grpc.ClientStream
}

type resourceServiceGetRolesClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetRolesClient) Recv() (*GetRolesRsp, error) {
	m := new(GetRolesRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *resourceServiceClient) GetApplications(ctx context.Context, in *GetApplicationsRqst, opts ...grpc.CallOption) (ResourceService_GetApplicationsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceService_ServiceDesc.Streams[4], ResourceService_GetApplications_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &resourceServiceGetApplicationsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetApplicationsClient interface {
	Recv() (*GetApplicationsRsp, error)
	grpc.ClientStream
}

type resourceServiceGetApplicationsClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetApplicationsClient) Recv() (*GetApplicationsRsp, error) {
	m := new(GetApplicationsRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *resourceServiceClient) GetPeers(ctx context.Context, in *GetPeersRqst, opts ...grpc.CallOption) (ResourceService_GetPeersClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ResourceService_ServiceDesc.Streams[5], ResourceService_GetPeers_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &resourceServiceGetPeersClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetPeersClient interface {
	Recv() (*GetPeersRsp, error)
	grpc.ClientStream
}

type resourceServiceGetPeersClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetPeersClient) Recv() (*GetPeersRsp, error) {
	m := new(GetPeersRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *resourceServiceClient) GetNotifications(ctx context.Context, in *GetNotificationsRqst, opts ...grpc.CallOption) (ResourceService_GetNotificationsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &resourceServiceGetNotificationsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetNotificationsClient interface {
	Recv() (*GetNotificationsRsp, error)
	grpc.ClientStream
}

type resourceServiceGetNotificationsClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetNotificationsClient) Recv() (*GetNotificationsRsp, error) {
	m := new(GetNotificationsRsp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *resourceServiceClient) GetPackagesDescriptor(ctx context.Context, in *GetPackagesDescriptorRequest, opts ...grpc.CallOption) (ResourceService_GetPackagesDescriptorClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &resourceServiceGetPackagesDescriptorClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ResourceService_GetPackagesDescriptorClient interface {
	Recv() (*GetPackagesDescriptorResponse, error)
	grpc.ClientStream
}

type resourceServiceGetPackagesDescriptorClient struct {
	grpc.ClientStream
}

func (x *resourceServiceGetPackagesDescriptorClient) Recv() (*GetPackagesDescriptorResponse, error) {
...
type ResourceServiceServer interface {
	...
	// Retrieves a list of organizations.
	GetOrganizations(*GetOrganizationsRqst, ResourceService_GetOrganizationsServer) error
	// Deletes an organization.
	...
	// Retrieves a list of groups.
	GetGroups(*GetGroupsRqst, ResourceService_GetGroupsServer) error
	// Deletes a group.
	...
	// Retrieves a list of accounts.
	GetAccounts(*GetAccountsRqst, ResourceService_GetAccountsServer) error
	// Adds a role to an account.
	...
	// Retrieves a list of roles.
	GetRoles(*GetRolesRqst, ResourceService_GetRolesServer) error
	// Deletes a role by its ID.
	...
	// Retrieves information about all applications in a JSON format.
	GetApplications(*GetApplicationsRqst, ResourceService_GetApplicationsServer) error
	// Deletes an application from the server.
	...
	// Retrieves a list of all peers in the network.
	GetPeers(*GetPeersRqst, ResourceService_GetPeersServer) error
	// Gets the approval state of a peer from another peer's perspective.
	...
	// Retrieves a stream of notifications.
	GetNotifications(*GetNotificationsRqst, ResourceService_GetNotificationsServer) error
	// Deletes a specific notification.
	...
	// Retrieves descriptors for all packages.
	GetPackagesDescriptor(*GetPackagesDescriptorRequest, ResourceService_GetPackagesDescriptorServer) error
	// Saves or updates a service package descriptor.
...
func (UnimplementedResourceServiceServer) GetOrganizations(*GetOrganizationsRqst, ResourceService_GetOrganizationsServer) error {
...
func (UnimplementedResourceServiceServer) GetGroups(*GetGroupsRqst, ResourceService_GetGroupsServer) error {
...
func (UnimplementedResourceServiceServer) GetAccounts(*GetAccountsRqst, ResourceService_GetAccountsServer) error {
...
func (UnimplementedResourceServiceServer) GetRoles(*GetRolesRqst, ResourceService_GetRolesServer) error {
...
func (UnimplementedResourceServiceServer) GetApplications(*GetApplicationsRqst, ResourceService_GetApplicationsServer) error {
...
func (UnimplementedResourceServiceServer) GetPeers(*GetPeersRqst, ResourceService_GetPeersServer) error {
...
func (UnimplementedResourceServiceServer) GetNotifications(*GetNotificationsRqst, ResourceService_GetNotificationsServer) error {
...
func (UnimplementedResourceServiceServer) GetPackagesDescriptor(*GetPackagesDescriptorRequest, ResourceService_GetPackagesDescriptorServer) error {
...
func _ResourceService_GetOrganizations_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetOrganizations(m, &resourceServiceGetOrganizationsServer{ServerStream: stream})
}

type ResourceService_GetOrganizationsServer interface {
	Send(*GetOrganizationsRsp) error
	grpc.ServerStream
}

type resourceServiceGetOrganizationsServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetOrganizationsServer) Send(m *GetOrganizationsRsp) error {
...
func _ResourceService_GetGroups_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetGroups(m, &resourceServiceGetGroupsServer{ServerStream: stream})
}

type ResourceService_GetGroupsServer interface {
	Send(*GetGroupsRsp) error
	grpc.ServerStream
}

type resourceServiceGetGroupsServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetGroupsServer) Send(m *GetGroupsRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetAccounts(m, &resourceServiceGetAccountsServer{ServerStream: stream})
}

type ResourceService_GetAccountsServer interface {
	Send(*GetAccountsRsp) error
	grpc.ServerStream
}

type resourceServiceGetAccountsServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetAccountsServer) Send(m *GetAccountsRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetRoles_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetRoles(m, &resourceServiceGetRolesServer{ServerStream: stream})
}

type ResourceService_GetRolesServer interface {
	Send(*GetRolesRsp) error
	grpc.ServerStream
}

type resourceServiceGetRolesServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetRolesServer) Send(m *GetRolesRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetApplications_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetApplications(m, &resourceServiceGetApplicationsServer{ServerStream: stream})
}

type ResourceService_GetApplicationsServer interface {
	Send(*GetApplicationsRsp) error
	grpc.ServerStream
}

type resourceServiceGetApplicationsServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetApplicationsServer) Send(m *GetApplicationsRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetPeers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetPeers(m, &resourceServiceGetPeersServer{ServerStream: stream})
}

type ResourceService_GetPeersServer interface {
	Send(*GetPeersRsp) error
	grpc.ServerStream
}

type resourceServiceGetPeersServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetPeersServer) Send(m *GetPeersRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetNotifications_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetNotifications(m, &resourceServiceGetNotificationsServer{ServerStream: stream})
}

type ResourceService_GetNotificationsServer interface {
	Send(*GetNotificationsRsp) error
	grpc.ServerStream
}

type resourceServiceGetNotificationsServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetNotificationsServer) Send(m *GetNotificationsRsp) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ResourceService_GetPackagesDescriptor_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ResourceServiceServer).GetPackagesDescriptor(m, &resourceServiceGetPackagesDescriptorServer{ServerStream: stream})
}

type ResourceService_GetPackagesDescriptorServer interface {
	Send(*GetPackagesDescriptorResponse) error
	grpc.ServerStream
}

type resourceServiceGetPackagesDescriptorServer struct {
	grpc.ServerStream
}

func (x *resourceServiceGetPackagesDescriptorServer) Send(m *GetPackagesDescriptorResponse) error {
	return x.ServerStream.SendMsg(m)
}
