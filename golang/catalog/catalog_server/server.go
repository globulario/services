...
func main() {
	...
	policy.GlobalResolver().Register([]policy.Permission{
		{Method: "/catalog.CatalogService/getSupplier", Action: "catalog.getsupplier"},
		{Method: "/catalog.CatalogService/getSuppliers", Action: "catalog.getsuppliers"},
		{Method: "/catalog.CatalogService/getManufacturer", Action: "catalog.getmanufacturer"},
		{Method: "/catalog.CatalogService/getManufacturers", Action: "catalog.getmanufacturers"},
		{Method: "/catalog.CatalogService/getSupplierPackages", Action: "catalog.getsupplierpackages"},
		{Method: "/catalog.CatalogService/getPackage", Action: "catalog.getpackage"},
		{Method: "/catalog.CatalogService/getPackages", Action: "catalog.getpackages"},
		{Method: "/catalog.CatalogService/getUnitOfMeasure", Action: "catalog.getunitofmeasure"},
		{Method: "/catalog.CatalogService/getUnitOfMeasures", Action: "catalog.getunitofmeasures"},
		{Method: "/catalog.CatalogService/getItemDefinition", Action: "catalog.getitemdefinition"},
		{Method: "/catalog.CatalogService/getItemDefinitions", Action: "catalog.getitemdefinitions"},
		{Method: "/catalog.CatalogService/getItemInstance", Action: "catalog.getiteminstance"},
		{Method: "/catalog.CatalogService/getItemInstances", Action: "catalog.getiteminstances"},
		{Method: "/catalog.CatalogService/getLocalisation", Action: "catalog.getlocalisation"},
		{Method: "/catalog.CatalogService/getLocalisations", Action: "catalog.getlocalisations"},
		{Method: "/catalog.CatalogService/getCategory", Action: "catalog.getcategory"},
		{Method: "/catalog.CatalogService/getCategories", Action: "catalog.getcategories"},
		{Method: "/catalog.CatalogService/getInventories", Action: "catalog.getinventories"},
		{Method: "/catalog.CatalogService/SaveUnitOfMeasure", Action: "catalog.saveunitofmeasure"},
		{Method: "/catalog.CatalogService/SavePropertyDefinition", Action: "catalog.savepropertydefinition"},
		{Method: "/catalog.CatalogService/SaveItemDefinition", Action: "catalog.saveitemdefinition"},
		{Method: "/catalog.CatalogService/SaveItemInstance", Action: "catalog.saveiteminstance"},
		{Method: "/catalog.CatalogService/SaveInventory", Action: "catalog.saveinventory"},
		{Method: "/catalog.CatalogService/SaveManufacturer", Action: "catalog.savemanufacturer"},
		{Method: "/catalog.CatalogService/SaveSupplier", Action: "catalog.savesupplier"},
		{Method: "/catalog.CatalogService/SaveLocalisation", Action: "catalog.savelocalisation"},
		{Method: "/catalog.CatalogService/SavePackage", Action: "catalog.savepackage"},
		{Method: "/catalog.CatalogService/SavePackageSupplier", Action: "catalog.savepackagesupplier"},
		{Method: "/catalog.CatalogService/SaveItemManufacturer", Action: "catalog.saveitemmanufacturer"},
		{Method: "/catalog.CatalogService/SaveCategory", Action: "catalog.savecategory"},
		{Method: "/catalog.CatalogService/AppendItemDefinitionCategory", Action: "catalog.appenditemdefinitioncategory"},
		{Method: "/catalog.CatalogService/RemoveItemDefinitionCategory", Action: "catalog.removeitemdefinitioncategory"},
		{Method: "/catalog.CatalogService/deleteInventory", Action: "catalog.deleteinventory"},
		{Method: "/catalog.CatalogService/deletePackage", Action: "catalog.deletepackage"},
		{Method: "/catalog.CatalogService/deletePackageSupplier", Action: "catalog.deletepackagesupplier"},
		{Method: "/catalog.CatalogService/deleteSupplier", Action: "catalog.deletesupplier"},
		{Method: "/catalog.CatalogService/deletePropertyDefinition", Action: "catalog.deletepropertydefinition"},
		{Method: "/catalog.CatalogService/deleteUnitOfMeasure", Action: "catalog.deleteunitofmeasure"},
		{Method: "/catalog.CatalogService/deleteItemInstance", Action: "catalog.deleteiteminstance"},
		{Method: "/catalog.CatalogService/deleteManufacturer", Action: "catalog.deletemanufacturer"},
		{Method: "/catalog.CatalogService/deleteItemManufacturer", Action: "catalog.deleteitemmanufacturer"},
		{Method: "/catalog.CatalogService/deleteCategory", Action: "catalog.deletecategory"},
		{Method: "/catalog.CatalogService/deleteLocalisation", Action: "catalog.deletelocalisation"},
		{Method: "/catalog.CatalogService/CreateConnection", Action: "catalog.createconnection"},
		{Method: "/catalog.CatalogService/DeleteConnection", Action: "catalog.deleteconnection"},
		{Method: "/catalog.CatalogService/Stop", Action: "catalog.stop"},
	})
