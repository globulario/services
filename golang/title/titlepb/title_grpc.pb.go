...
type TitleServiceClient interface {
	...
	SearchTitles(ctx context.Context, in *SearchTitlesRequest, opts ...grpc.CallOption) (TitleService_SearchTitlesClient, error)
	// Searches for persons (e.g., YouTubers, actors, directors) based on given criteria.
	SearchPersons(ctx context.Context, in *SearchPersonsRequest, opts ...grpc.CallOption) (TitleService_SearchPersonsClient, error)
}
...
func (c *titleServiceClient) SearchTitles(ctx context.Context, in *SearchTitlesRequest, opts ...grpc.CallOption) (TitleService_SearchTitlesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TitleService_ServiceDesc.Streams[0], TitleService_SearchTitles_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &titleServiceSearchTitlesClient{ClientStream: stream}
...
type TitleService_SearchTitlesClient interface {
	Recv() (*SearchTitlesResponse, error)
	grpc.ClientStream
}

type titleServiceSearchTitlesClient struct {
	grpc.ClientStream
}

func (x *titleServiceSearchTitlesClient) Recv() (*SearchTitlesResponse, error) {
	m := new(SearchTitlesResponse)
...
func (c *titleServiceClient) SearchPersons(ctx context.Context, in *SearchPersonsRequest, opts ...grpc.CallOption) (TitleService_SearchPersonsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TitleService_ServiceDesc.Streams[1], TitleService_SearchPersons_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &titleServiceSearchPersonsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type TitleService_SearchPersonsClient interface {
	Recv() (*SearchPersonsResponse, error)
	grpc.ClientStream
}

type titleServiceSearchPersonsClient struct {
	grpc.ClientStream
}

func (x *titleServiceSearchPersonsClient) Recv() (*SearchPersonsResponse, error) {
	m := new(SearchPersonsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TitleServiceServer interface {
	...
	// Searches for titles or videos based on given criteria.
	SearchTitles(*SearchTitlesRequest, TitleService_SearchTitlesServer) error
	// Searches for persons (e.g., YouTubers, actors, directors) based on given criteria.
	SearchPersons(*SearchPersonsRequest, TitleService_SearchPersonsServer) error
}

// UnimplementedTitleServiceServer should be embedded to have forward compatible implementations.
...
func (UnimplementedTitleServiceServer) SearchTitles(*SearchTitlesRequest, TitleService_SearchTitlesServer) error {
	return status.Errorf(codes.Unimplemented, "method SearchTitles not implemented")
}
func (UnimplementedTitleServiceServer) SearchPersons(*SearchPersonsRequest, TitleService_SearchPersonsServer) error {
...
func _TitleService_SearchTitles_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TitleServiceServer).SearchTitles(m, &titleServiceSearchTitlesServer{ServerStream: stream})
}

type TitleService_SearchTitlesServer interface {
	Send(*SearchTitlesResponse) error
	grpc.ServerStream
}

type titleServiceSearchTitlesServer struct {
	grpc.ServerStream
}

func (x *titleServiceSearchTitlesServer) Send(m *SearchTitlesResponse) error {
...
func _TitleService_SearchPersons_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TitleServiceServer).SearchPersons(m, &titleServiceSearchPersonsServer{ServerStream: stream})
}

type TitleService_SearchPersonsServer interface {
	Send(*SearchPersonsResponse) error
	grpc.ServerStream
}

type titleServiceSearchPersonsServer struct {
	grpc.ServerStream
}

func (x *titleServiceSearchPersonsServer) Send(m *SearchPersonsResponse) error {
	return x.ServerStream.SendMsg(m)
}
