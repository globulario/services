...
func (srv *server) loadMinioConfig() *config.MinioProxyConfig {
	// etcd-only — no env vars, no disk contracts, no loopback.
...
func main() {
	...
	policy.GlobalResolver().Register([]policy.Permission{
		{Method: "/media.MediaService/GetVideoConversionErrors", Action: "media.geterrors"},
		{Method: "/media.MediaService/GetVideoConversionLogs", Action: "media.getlogs"},
		{Method: "/media.MediaService/IsProcessVideo", Action: "media.isprocessing"},
		{Method: "/media.MediaService/ListMediaFiles", Action: "media.list"},
		{Method: "/media.MediaService/UploadVideo", Action: "media.upload"},
		{Method: "/media.MediaService/GeneratePlaylist", Action: "media.playlist"},
		{Method: "/media.MediaService/CreateVttFile", Action: "media.vtt"},
		{Method: "/media.MediaService/CreateVideoPreview", Action: "media.preview"},
		{Method: "/media.MediaService/CreateVideoTimeLine", Action: "media.timeline"},
		{Method: "/media.MediaService/ConvertVideoToMpeg4H264", Action: "media.converth264"},
		{Method: "/media.MediaService/ConvertVideoToHls", Action: "media.converthls"},
		{Method: "/media.MediaService/StartProcessVideo", Action: "media.processvideo"},
		{Method: "/media.MediaService/StartProcessAudio", Action: "media.processaudio"},
		{Method: "/media.MediaService/StopProcessVideo", Action: "media.stopprocess"},
		{Method: "/media.MediaService/Stop", Action: "media.stop"},
		{Method: "/media.MediaService/SetVideoConversion", Action: "media.setconversion"},
		{Method: "/media.MediaService/SetVideoStreamConversion", Action: "media.setstreamconversion"},
		{Method: "/media.MediaService/SetStartVideoConversionHour", Action: "media.setstarthour"},
		{Method: "/media.MediaService/SetMaximumVideoConversionDelay", Action: "media.setmaxdelay"},
		{Method: "/media.MediaService/ClearVideoConversionErrors", Action: "media.clearerrors"},
		{Method: "/media.MediaService/ClearVideoConversionError", Action: "media.clearerror"},
		{Method: "/media.MediaService/ClearVideoConversionLogs", Action: "media.clearlogs"},
	})
