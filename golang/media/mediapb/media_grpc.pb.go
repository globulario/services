...
type MediaServiceClient interface {
	...
	UploadVideo(ctx context.Context, in *UploadVideoRequest, opts ...grpc.CallOption) (MediaService_UploadVideoClient, error)
...
func (c *mediaServiceClient) UploadVideo(ctx context.Context, in *UploadVideoRequest, opts ...grpc.CallOption) (MediaService_UploadVideoClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MediaService_ServiceDesc.Streams[0], MediaService_UploadVideo_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &mediaServiceUploadVideoClient{ClientStream: stream}
...
type MediaService_UploadVideoClient interface {
	Recv() (*UploadVideoResponse, error)
	grpc.ClientStream
}

type mediaServiceUploadVideoClient struct {
	grpc.ClientStream
}

func (x *mediaServiceUploadVideoClient) Recv() (*UploadVideoResponse, error) {
...
type MediaServiceServer interface {
	...
	// Upload a video from a URL (e.g., YouTube, Hulu, Pornhub).
	UploadVideo(*UploadVideoRequest, MediaService_UploadVideoServer) error
	// Create a video preview.
...
func (UnimplementedMediaServiceServer) UploadVideo(*UploadVideoRequest, MediaService_UploadVideoServer) error {
...
func _MediaService_UploadVideo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MediaServiceServer).UploadVideo(m, &mediaServiceUploadVideoServer{ServerStream: stream})
}

type MediaService_UploadVideoServer interface {
	Send(*UploadVideoResponse) error
	grpc.ServerStream
}

type mediaServiceUploadVideoServer struct {
	grpc.ServerStream
}

func (x *mediaServiceUploadVideoServer) Send(m *UploadVideoResponse) error {
