...
type PersistenceServiceClient interface {
	...
	InsertMany(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[InsertManyRqst, InsertManyRsp], error)
	// Find - Retrieves multiple documents based on a query.
	Find(ctx context.Context, in *FindRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FindResp], error)
	...
	Aggregate(ctx context.Context, in *AggregateRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AggregateResp], error)
...
func (c *persistenceServiceClient) InsertMany(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[InsertManyRqst, InsertManyRsp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[InsertManyRqst, InsertManyRsp]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_InsertManyClient = grpc.ClientStreamingClient[InsertManyRqst, InsertManyRsp]

func (c *persistenceServiceClient) Find(ctx context.Context, in *FindRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FindResp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PersistenceService_ServiceDesc.Streams[1], PersistenceService_Find_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[FindRqst, FindResp]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_FindClient = grpc.ServerStreamingClient[FindResp]
...
func (c *persistenceServiceClient) Aggregate(ctx context.Context, in *AggregateRqst, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AggregateResp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PersistenceService_ServiceDesc.Streams[2], PersistenceService_Aggregate_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[AggregateRqst, AggregateResp]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_AggregateClient = grpc.ServerStreamingClient[AggregateResp]
...
type PersistenceServiceServer interface {
	...
	// InsertMany - Inserts multiple documents into a collection.
	InsertMany(grpc.ClientStreamingServer[InsertManyRqst, InsertManyRsp]) error
	// Find - Retrieves multiple documents based on a query.
	Find(*FindRqst, grpc.ServerStreamingServer[FindResp]) error
	// FindOne - Retrieves a single document based on a query.
	FindOne(context.Context, *FindOneRqst) (*FindOneResp, error)
	// Aggregate - Performs aggregation operations on a collection.
	Aggregate(*AggregateRqst, grpc.ServerStreamingServer[AggregateResp]) error
	// Update - Updates multiple documents in a collection.
...
// UnimplementedPersistenceServiceServer should be embedded to have
...
func (UnimplementedPersistenceServiceServer) InsertOne(context.Context, *InsertOneRqst) (*InsertOneRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method InsertOne not implemented")
}
func (UnimplementedPersistenceServiceServer) InsertMany(grpc.ClientStreamingServer[InsertManyRqst, InsertManyRsp]) error {
	return status.Error(codes.Unimplemented, "method InsertMany not implemented")
}
func (UnimplementedPersistenceServiceServer) Find(*FindRqst, grpc.ServerStreamingServer[FindResp]) error {
...
func (UnimplementedPersistenceServiceServer) Aggregate(*AggregateRqst, grpc.ServerStreamingServer[AggregateResp]) error {
...
func (UnimplementedPersistenceServiceServer) UpdateOne(context.Context, *UpdateOneRqst) (*UpdateOneRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOne not implemented")
}
func (UnimplementedPersistenceServiceServer) ReplaceOne(context.Context, *ReplaceOneRqst) (*ReplaceOneRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method ReplaceOne not implemented")
}
...
func (UnimplementedPersistenceServiceServer) RunAdminCmd(context.Context, *RunAdminCmdRqst) (*RunAdminCmdRsp, error) {
	return nil, status.Error(codes.Unimplemented, "method RunAdminCmd not implemented")
}
...
func _PersistenceService_InsertMany_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PersistenceServiceServer).InsertMany(&grpc.GenericServerStream[InsertManyRqst, InsertManyRsp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_InsertManyServer = grpc.ClientStreamingServer[InsertManyRqst, InsertManyRsp]
...
func _PersistenceService_Find_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PersistenceServiceServer).Find(m, &grpc.GenericServerStream[FindRqst, FindResp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_FindServer = grpc.ServerStreamingServer[FindResp]
...
func _PersistenceService_Aggregate_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PersistenceServiceServer).Aggregate(m, &grpc.GenericServerStream[AggregateRqst, AggregateResp]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PersistenceService_AggregateServer = grpc.ServerStreamingServer[AggregateResp]
