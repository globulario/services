...
func TestReconcileOrderDNSBeforeCerts(t *testing.T) {
	...
	calls := []string{}
	srv.syncDNSHook = func(*cluster_controllerpb.ClusterNetworkSpec) error {
		calls = append(calls, "syncDNS")
		return nil
	}
	srv.waitDNSHook = func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error {
		calls = append(calls, "waitDNS")
		return nil
	}
	srv.ensureCertsHook = func(*cluster_controllerpb.ClusterNetworkSpec) error {
	...
	srv.healthCheckHook = func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error {
...
func TestReconcileDNSReadinessFailureStopsCerts(t *testing.T) {
	...
	srv.objectstoreLayoutHook = func(ctx context.Context, domain string) error { return nil }
	srv.healthCheckHook = func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error { return nil }
	spec := &cluster_controllerpb.ClusterNetworkSpec{
		ClusterDomain: "example.com",
		Protocol:      "https",
		AcmeEnabled:   true,
