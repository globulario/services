...
import (
	...
	certpkg "github.com/globulario/services/golang/node_agent/node_agent_server/internal/certs"
)
...
func TestCertWatcher_RestartsOnGenerationIncrease(t *testing.T) {
	...
	srv := &NodeAgentServer{
		...
		lastSpec:  &cluster_controllerpb.ClusterNetworkSpec{ClusterDomain: "example.com", Protocol: "https"},
