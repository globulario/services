...
func TestReconcileNetworkSyncsWhenGenerationZero(t *testing.T) {
	...
	srv := &NodeAgentServer{
		...
		syncDNSHook: func(spec *cluster_controllerpb.ClusterNetworkSpec) error {
			syncCalled = true
			return nil
		},
		waitDNSHook: func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error {
			return nil
		},
		ensureCertsHook: func(spec *cluster_controllerpb.ClusterNetworkSpec) error {
			return nil
		},
		...
		healthCheckHook: func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error { return nil },
	}
...
func TestReconcileNetworkOrder_DNSBeforeCertsAndHealth(t *testing.T) {
	...
	srv := &NodeAgentServer{
		...
		healthCheckHook: func(ctx context.Context, spec *cluster_controllerpb.ClusterNetworkSpec) error {
