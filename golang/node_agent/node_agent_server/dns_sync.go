...
func dnsAdminEmail(spec *cluster_controllerpb.ClusterNetworkSpec) string {
	if spec == nil {
		return ""
	}
...
func makeDNSToken(nodeID string, client *dns_client.Dns_Client, spec *cluster_controllerpb.ClusterNetworkSpec) (string, error) {
	if spec == nil {
