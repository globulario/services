...
const file_catalog_proto_rawDesc = "" +
	...
	"\x04euro\x10\x022\xb7$\n" +
	"\x0eCatalogService\x123\n" +
	"\x04Stop\x12\x14.catalog.StopRequest\x1a\x15.catalog.StopResponse\x12Q\n" +
	"\x10CreateConnection\x12\x1d.catalog.CreateConnectionRqst\x1a\x1c.catalog.CreateConnectionRsp\"\x00\x12\x9a\x01\n" +
	"\x10DeleteConnection\x12\x1d.catalog.DeleteConnectionRqst\x1a\x1c.catalog.DeleteConnectionRsp\"I\x82\xb5\x18E\n" +
	"\x19catalog.connection.delete\x12\x06delete\x1a\x19/catalog/connections/{id}*\x05admin\x12\\\n" +
	"\x11SaveUnitOfMeasure\x12!.catalog.SaveUnitOfMeasureRequest\x1a\".catalog.SaveUnitOfMeasureResponse\"\x00\x12k\n" +
	"\x16SavePropertyDefinition\x12&.catalog.SavePropertyDefinitionRequest\x1a'.catalog.SavePropertyDefinitionResponse\"\x00\x12\xc7\x01\n" +
	"\x12SaveItemDefinition\x12\".catalog.SaveItemDefinitionRequest\x1a#.catalog.SaveItemDefinitionResponse\"h\x82\xb5\x18d\n" +
	"\x1dcatalog.item_definition.write\x12\x05write\"4/catalog/connections/{connectionId}/item-definitions*\x06editor\x12Y\n" +
	...
	"\fSaveCategory\x12\x1c.catalog.SaveCategoryRequest\x1a\x1d.catalog.SaveCategoryResponse\"\x00\x12\xed\x01\n" +
	...
	"%catalog.item_definition.category.link\x12\x05write\"4/catalog/connections/{connectionId}/item-definitions*\x06editor\x12{\n" +
	...
	"\x11getUnitOfMeasures\x12!.catalog.GetUnitOfMeasuresRequest\x1a\".catalog.GetUnitOfMeasuresResponse\x12\xd5\x01\n" +
	...
	"\x1ccatalog.item_definition.list\x12\x04read\"4/catalog/connections/{connectionId}/item-definitions*\x06viewer\x12T\n" +
