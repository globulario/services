...
func deduceProfiles(caps *clustercontrollerpb.NodeCapabilities) []string {
...
func capsToStored(caps *clustercontrollerpb.NodeCapabilities) *storedCapabilities {
	if caps == nil {
		return nil
	}
...
func storedToProtoCapabilities(c *storedCapabilities) *clustercontrollerpb.NodeCapabilities {
	if c == nil {
		return nil
	}
	return &clustercontrollerpb.NodeCapabilities{
		CpuCount:      c.CPUCount,
		RamBytes:      c.RAMBytes,
