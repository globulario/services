...
import (
	...
	"github.com/globulario/services/golang/clusterdoctor/clusterdoctor_server/internal/recovery"
...
func main() {
	...
	clusterdoctorpb.RegisterClusterDoctorServiceServer(grpcServer, srv)
	...
	if err := config.SaveServiceConfiguration(map[string]interface{}{
		"Id":       "clusterdoctor.ClusterDoctorService",
		"Name":     "clusterdoctor.ClusterDoctorService",
		"Address":  "localhost",
		"Port":     cfg.Port,
		"Protocol": "grpc",
		"TLS":      false,
