...
// Config captures sql service configuration.
type Config struct {
	ID                 string   `json:"Id"`
...
func DefaultConfig() *Config {
	cfg := &Config{
		...
		Description:     "SQL access microservice.",
		Keywords:        []string{"SQL", "Database", "Service"},
		Repositories:    []string{},
		Discoveries:     []string{},
		Dependencies:    []string{"rbac.RbacService", "log.LogService"},
