module github.com/globulario/services/golang/spc/spc_client
...
replace github.com/globulario/services/golang/spc/spcpb => ../spcpb
...
require (
	...
	github.com/globulario/services/golang/spc/spcpb v0.0.0-00010101000000-000000000000
