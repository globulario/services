...
type EventServiceClient interface {
	...
	OnEvent(ctx context.Context, in *OnEventRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OnEventResponse], error)
...
func (c *eventServiceClient) OnEvent(ctx context.Context, in *OnEventRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OnEventResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type EventService_OnEventClient = grpc.ServerStreamingClient[OnEventResponse]
...
type EventServiceServer interface {
	...
	// Stream of events for a client.
	OnEvent(*OnEventRequest, grpc.ServerStreamingServer[OnEventResponse]) error
	// Quit the ongoing event stream.
...
func (UnimplementedEventServiceServer) OnEvent(*OnEventRequest, grpc.ServerStreamingServer[OnEventResponse]) error {
...
func _EventService_OnEvent_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(EventServiceServer).OnEvent(m, &grpc.GenericServerStream[OnEventRequest, OnEventResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type EventService_OnEventServer = grpc.ServerStreamingServer[OnEventResponse]
