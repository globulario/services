...
func defaultReleasePackageOpts() releasePackageTestOpts {
	return releasePackageTestOpts{
		...
		installPackage:         func(ctx context.Context, name, version, kind, buildID, desiredHash string, buildNumber int64) error { return nil },
...
func TestReleasePackage_ServiceRolloutSuccess(t *testing.T) {
	...
	opts := defaultReleasePackageOpts()
	opts.installPackage = func(ctx context.Context, name, version, kind, buildID, desiredHash string, buildNumber int64) error {
...
func TestReleasePackage_WorkloadPartialFailure(t *testing.T) {
	...
	opts.syncInstalledPackage = func(ctx context.Context, name, version, hash, kind, buildID string) error { return nil }
