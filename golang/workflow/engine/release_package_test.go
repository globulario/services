...
func defaultReleasePackageOpts() releasePackageTestOpts {
	return releasePackageTestOpts{
		...
		installPackage:         func(ctx context.Context, name, version, kind, buildID string, buildNumber int64) error { return nil },
...
func TestReleasePackage_ServiceRolloutSuccess(t *testing.T) {
	...
	opts := defaultReleasePackageOpts()
	opts.installPackage = func(ctx context.Context, name, version, kind, buildID string, buildNumber int64) error {
