...
type ConversationServiceClient interface {
	...
	Connect(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (ConversationService_ConnectClient, error)
	...
	// Join a conversation.
	JoinConversation(ctx context.Context, in *JoinConversationRequest, opts ...grpc.CallOption) (ConversationService_JoinConversationClient, error)
	...
	// Retreive a conversation by keywords or name...
	FindMessages(ctx context.Context, in *FindMessagesRequest, opts ...grpc.CallOption) (ConversationService_FindMessagesClient, error)
...
func (c *conversationServiceClient) Connect(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (ConversationService_ConnectClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ConversationService_ServiceDesc.Streams[0], ConversationService_Connect_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &conversationServiceConnectClient{ClientStream: stream}
...
type ConversationService_ConnectClient interface {
	Recv() (*ConnectResponse, error)
	grpc.ClientStream
}

type conversationServiceConnectClient struct {
	grpc.ClientStream
}

func (x *conversationServiceConnectClient) Recv() (*ConnectResponse, error) {
...
func (c *conversationServiceClient) JoinConversation(ctx context.Context, in *JoinConversationRequest, opts ...grpc.CallOption) (ConversationService_JoinConversationClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &conversationServiceJoinConversationClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ConversationService_JoinConversationClient interface {
	Recv() (*JoinConversationResponse, error)
	grpc.ClientStream
}

type conversationServiceJoinConversationClient struct {
	grpc.ClientStream
}

func (x *conversationServiceJoinConversationClient) Recv() (*JoinConversationResponse, error) {
	m := new(JoinConversationResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *conversationServiceClient) FindMessages(ctx context.Context, in *FindMessagesRequest, opts ...grpc.CallOption) (ConversationService_FindMessagesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &conversationServiceFindMessagesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ConversationService_FindMessagesClient interface {
	Recv() (*FindMessagesResponse, error)
	grpc.ClientStream
}

type conversationServiceFindMessagesClient struct {
	grpc.ClientStream
}

func (x *conversationServiceFindMessagesClient) Recv() (*FindMessagesResponse, error) {
	m := new(FindMessagesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ConversationServiceServer interface {
	...
	// Connect will open a channel between the conversation sever and it client
	// and that channel will be use to send all conversation message.
	Connect(*ConnectRequest, ConversationService_ConnectServer) error
	// Close connection with the conversation server.
	...
	// Join a conversation.
	JoinConversation(*JoinConversationRequest, ConversationService_JoinConversationServer) error
	// Leave a given conversation.
	...
	// Retreive a conversation by keywords or name...
	FindMessages(*FindMessagesRequest, ConversationService_FindMessagesServer) error
	// append a like message
...
func (UnimplementedConversationServiceServer) Connect(*ConnectRequest, ConversationService_ConnectServer) error {
...
func (UnimplementedConversationServiceServer) JoinConversation(*JoinConversationRequest, ConversationService_JoinConversationServer) error {
...
func (UnimplementedConversationServiceServer) FindMessages(*FindMessagesRequest, ConversationService_FindMessagesServer) error {
...
func _ConversationService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ConversationServiceServer).Connect(m, &conversationServiceConnectServer{ServerStream: stream})
}

type ConversationService_ConnectServer interface {
	Send(*ConnectResponse) error
	grpc.ServerStream
}

type conversationServiceConnectServer struct {
	grpc.ServerStream
}

func (x *conversationServiceConnectServer) Send(m *ConnectResponse) error {
...
func _ConversationService_JoinConversation_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ConversationServiceServer).JoinConversation(m, &conversationServiceJoinConversationServer{ServerStream: stream})
}

type ConversationService_JoinConversationServer interface {
	Send(*JoinConversationResponse) error
	grpc.ServerStream
}

type conversationServiceJoinConversationServer struct {
	grpc.ServerStream
}

func (x *conversationServiceJoinConversationServer) Send(m *JoinConversationResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _ConversationService_FindMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ConversationServiceServer).FindMessages(m, &conversationServiceFindMessagesServer{ServerStream: stream})
}

type ConversationService_FindMessagesServer interface {
	Send(*FindMessagesResponse) error
	grpc.ServerStream
}

type conversationServiceFindMessagesServer struct {
	grpc.ServerStream
}

func (x *conversationServiceFindMessagesServer) Send(m *FindMessagesResponse) error {
	return x.ServerStream.SendMsg(m)
}
