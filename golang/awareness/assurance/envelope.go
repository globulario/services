...
// ─── Staleness/Alarm types are defined in freshness.go ───────────────────────
// AlarmSeverity, Alarm, Staleness, SourceFile, Options declared in freshness.go.
...
// ─── Coverage types are defined in coverage.go ───────────────────────────────
// CoverageLevel, FailureModeCoverage declared in coverage.go.
