...
func (UnimplementedPackageDiscoveryServer) PublishService(context.Context, *PublishServiceRequest) (*PublishServiceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PublishService not implemented")
}
...
func (UnimplementedPackageDiscoveryServer) ResolveInstallPlan(context.Context, *ResolveInstallPlanRequest) (*InstallPlan, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveInstallPlan not implemented")
}
...
func RegisterPackageDiscoveryServer(s grpc.ServiceRegistrar, srv PackageDiscoveryServer) {
	// If the following call panics, it indicates UnimplementedPackageDiscoveryServer was
