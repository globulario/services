...
namespace Ressource
{
    ...
    public class RessourceServiceImpl : RessourceService.RessourceServiceBase
    {
        ...
        public RessourceServiceImpl()
        {
            ...
            this.Name = "Ressource.RessourceService"; // The service name
            this.Version = "0.0.1";
            this.PublisherId = "localhost"; // must be the publisher id here...
            this.Domain = "localhost";
            this.Protocol = "grpc";
            this.Version = "0.0.1";            
            this.Value = "Ressource value!";
                
            // Retreive the prototype file path relative to where it was generated.
            this.Proto = global::Ressource.RessourceReflection.Descriptor.Name;
        ...
        public RessourceServiceImpl init()
        {
